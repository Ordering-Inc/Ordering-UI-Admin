...
var AnalyticsDriversFilterUI = function AnalyticsDriversFilterUI(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.AnalyticsDriversFilterContainer, null, usersList.loading ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles.SelectBtnWrapper, null, _toConsumableArray(Array(2).keys()).map(function (i) {
    ...
    return /*#__PURE__*/_react.default.createElement(_styles.TreeViewParentItem, {
      key: i
    }, /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
      width: 15,
      height: 15
    }), /*#__PURE__*/_react.default.createElement(_styles.TreeViewParentLabel, null, /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
      width: 120,
      height: 24
    })));
  })) : /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_styles.SelectBtnWrapper, null, /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
    color: isAllCheck === 'all' ? 'primary' : 'secundary',
    onClick: function onClick() {
      return changeAllCheckStatus('all');
    }
  }, t('SELECT_ALL', 'Select All')), /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
    ...
    return /*#__PURE__*/_react.default.createElement(_styles.TreeViewItemContainer, {
      key: i
    }, /*#__PURE__*/_react.default.createElement(_styles.TreeViewParentItem, null, /*#__PURE__*/_react.default.createElement("div", {
      onClick: function onClick() {
      ...
      className: "fill"
    }) : /*#__PURE__*/_react.default.createElement(_RiCheckboxBlankLine.default, null)), /*#__PURE__*/_react.default.createElement(_styles.TreeViewParentLabel, {
      onClick: function onClick() {
        return handleChangeCollapse(group.id);
      }
    }, group.name)), group.isCollapse && /*#__PURE__*/_react.default.createElement(_styles.TreeViewChildrenContainer, null, group === null || group === void 0 ? void 0 : group.children.map(function (user, i) {
      return /*#__PURE__*/_react.default.createElement(_styles.TreeViewChildrenItem, {
        key: i
        ...
        className: "fill"
      }) : /*#__PURE__*/_react.default.createElement(_RiCheckboxBlankLine.default, null)), /*#__PURE__*/_react.default.createElement(_styles.TreeViewChildrenLabel, null, user.name));
    })));
