...
exports.Title = exports.Thead = exports.Tfoot = exports.Tbody = exports.TableWrapper = exports.OrderStatusTableWrapper = exports.OrderStatusContainer = exports.EmptyContent = exports.DistanceTitleBlock = exports.DistanceTable = exports.CalendarWrapper = exports.ButtonActionList = exports.BrandBusinessWrapper = void 0;
...
var OrderStatusContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  padding: 25px 15px 70px 15px;\n  width: 100%;\n  overflow: auto;\n\n  @media (min-width: 700px) {\n    padding: 25px 35px 70px 35px;\n  }\n"])));
exports.OrderStatusContainer = OrderStatusContainer;
...
var OrderStatusTableWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 25px;\n  padding: 20px;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 7.6px;\n"])));
exports.OrderStatusTableWrapper = OrderStatusTableWrapper;
