...
var CustomerLegend = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n"])));
exports.CustomerLegend = CustomerLegend;
var LegendItem = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  margin-right: 20px;\n\n  ", "\n\n  p {\n    font-weight: 500;\n    font-size: 17px;\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme12;
...
var LegendContent = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  > div {\n    width: 12px;\n    height: 12px;\n    min-width: 12px;\n    min-height: 12px;\n    border-radius: 1px;\n    margin-right: 3px;\n    background: red;\n\n    ", "\n  }\n\n  > span {\n    font-size: 12px;\n    color: ", ";\n  }\n"])), function (props) {
...
var AnalyticsTimeZoneWrapper = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  width: 100%;\n  button {\n    margin-top: 5px;\n    background: ", ";\n    border-radius: 7.6px;\n    padding: 7px 15px;\n    font-size: 14px;\n    color: ", ";\n    border: none;\n  }\n\n  @media (min-width: 600px) {\n    width: fit-content;\n    margin-left: 10px;\n    ", "\n  }\n"])), function (props) {
...
var TimeZoneAndCalendar = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  width: 100%;\n\n  @media (min-width: 600px) {\n    flex-direction: row;\n    width: fit-content;\n  }\n"])));
