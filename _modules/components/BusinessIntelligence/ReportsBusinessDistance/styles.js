...
var DistancePerBrandWrapper = exports.DistancePerBrandWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 25px;\n  padding: 20px;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 7.6px;\n"])));
var DistanceTitleBlock = exports.DistanceTitleBlock = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 20px;\n\n  h2 {\n    font-weight: 600;\n    font-size: 12px;\n    margin: 0;\n    text-transform: uppercase;\n  }\n\n  svg {\n    font-size: 16px;\n    color: #212121;\n    cursor: pointer;\n  }\n\n  ", "\n"])), function (_ref) {
  var active = _ref.active;
  return !active && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    svg {\n      cursor: not-allowed;\n    }\n  "])));
});
var DistanceTable = exports.DistanceTable = _styledComponents.default.table(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  min-width: 500px;\n"])));
...
var Tbody = exports.Tbody = _styledComponents.default.tbody(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n\n  tr {\n    td {\n      padding: 12px 5px;\n      font-size: 12px;\n      text-align: center;\n      color: ", ";\n\n      &:not(:first-child):not(:last-child) {\n        border-left: 1px solid ", ";\n        border-right: 1px solid ", ";\n      }\n\n      &:first-child, &:nth-child(2) {\n        text-align: left;\n        color: ", ";\n      }\n    }\n  }\n"])), function (props) {
  ...
  var _props$theme0;
  return (_props$theme0 = props.theme) === null || _props$theme0 === void 0 ? void 0 : _props$theme0.colors.secundaryDarkContrast;
}, function (props) {
  var _props$theme1;
  return (_props$theme1 = props.theme) === null || _props$theme1 === void 0 ? void 0 : _props$theme1.colors.headingColor;
});
...
var CustomerLegend = exports.CustomerLegend = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n"])));
var LegendItem = exports.LegendItem = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  margin-right: 20px;\n\n  ", "\n\n  p {\n    font-weight: 500;\n    font-size: 17px;\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme10;
  return ((_props$theme10 = props.theme) === null || _props$theme10 === void 0 ? void 0 : _props$theme10.rtl) && (0, _styledComponents.css)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n    margin-right: 0;\n    margin-left: 20px;\n  "])));
});
var LegendContent = exports.LegendContent = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  > div {\n    width: 12px;\n    height: 12px;\n    min-width: 12px;\n    min-height: 12px;\n    border-radius: 1px;\n    margin-right: 3px;\n    background: red;\n\n    ", "\n  }\n\n  > span {\n    font-size: 12px;\n    color: ", ";\n  }\n"])), function (props) {
...
var AnalyticsTimeZoneWrapper = exports.AnalyticsTimeZoneWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  width: 100%;\n  button {\n    margin-top: 5px;\n    background: ", ";\n    border-radius: 7.6px;\n    padding: 7px 15px;\n    font-size: 14px;\n    color: ", ";\n    border: none;\n  }\n\n  @media (min-width: 600px) {\n    width: fit-content;\n    margin-left: 10px;\n    ", "\n  }\n"])), function (props) {
...
var TimeZoneAndCalendar = exports.TimeZoneAndCalendar = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  width: 100%;\n\n  @media (min-width: 600px) {\n    flex-direction: row;\n    width: fit-content;\n  }\n"])));