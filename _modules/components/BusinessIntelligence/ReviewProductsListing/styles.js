...
var ReviewsTable = _styledComponents.default.table(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  margin: 10px 0;\n  width: 100%;\n  thead {\n    tr {\n      border-bottom: solid 1px ", ";\n    }\n  }\n\n  th {\n    font-size: 12px;\n    font-weight: 700;\n  }\n\n  th, td {\n    padding: 10px 0;\n  }\n"])), function (props) {
  return props.theme.colors.disabled;
});
exports.ReviewsTable = ReviewsTable;
var ReviewTbody = _styledComponents.default.tbody(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  border-bottom: 1px solid ", ";\n  &:hover {\n    background-color: ", ";\n  }\n  ", "\n"])), function (props) {
...
exports.Image = Image;
var ReviewObject = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  display: flex;\n  align-items: center;\n\n  > div:first-child {\n    ", "\n  }\n\n  p {\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme2;
