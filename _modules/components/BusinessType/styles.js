...
exports.CheckBoxWrapper = exports.UploadImageIcon = exports.UploadImageIconContainer = exports.SkeletonWrapper = exports.BusinessTypeImage = exports.BusinessTypeEditWrapper = exports.Container = void 0;
...
var Container = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  border-bottom: 1px solid #E9ECEF;\n  transition: all 0.3s;\n\n  &:hover {\n    background: ", ";\n\n    .upload-icon {\n      display: block;\n    }\n\n    .business-type-name {\n      border: 1px solid ", ";\n      background: white;\n    }\n  }\n\n  > svg {\n    font-size: 20px;\n    cursor: pointer;\n    margin-left: 10px;\n    ", "\n  }\n"])), function (props) {
  ...
  return (_props$theme$colors = props.theme.colors) === null || _props$theme$colors === void 0 ? void 0 : _props$theme$colors.secundaryDarkContrast;
}, function (props) {
...
var BusinessTypeEditWrapper = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 9px 0;\n  flex: 1;\n\n  > input {\n    flex: 1;\n    height: 100%;\n    border: none;\n    outline: unset;\n    background: transparent;\n    font-size: 14px;\n    color: ", ";\n    border: 1px solid transparent;\n    transition: all 0.3s;\n\n    &:focus {\n      border: none;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
});

exports.BusinessTypeEditWrapper = BusinessTypeEditWrapper;

var BusinessTypeImage = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  height: 32px;\n  width: 32px;\n  border-radius: 8px;\n  overflow: hidden;\n  cursor: -webkit-grab;\n  cursor: grab;\n  filter: drop-shadow(0px 1px 4px rgba(0, 0, 0, 0.1));\n  margin: 0 10px;\n\n  ", "\n  img,\n  div {\n    width: 100%;\n    border-radius: 8px;\n    height: 100%;\n    overflow: hidden;\n  };\n\n  img{\n    object-fit: cover;\n  }\n"])), function (_ref) {
  var disabled = _ref.disabled;
  return disabled && (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});

exports.BusinessTypeImage = BusinessTypeImage;
...
var CheckBoxWrapper = _styledComponents.default.span(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  svg {\n    color: ", ";\n    font-size: 22px;\n  }\n\n  ", "\n\n  ", "\n"])), function (props) {
