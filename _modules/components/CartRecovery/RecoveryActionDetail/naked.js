          ...
          switch (_context.prev = _context.next) {
            ...
            case 11:
              ...
              if (!content.error) {
                ...
                cleanFormState();
                showToast(_orderingComponentsAdmin.ToastType.Success, t('RECOVERY_ACTION_SAVED', 'Recovery action saved'));
              } else {
                setActionState({
                  loading: false,
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              if (!content.error) {
                ...
                showToast(_orderingComponentsAdmin.ToastType.Success, t('RECOVERY_ACTION_ADDED', 'Recovery action added'));
          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 9:
              ...
              if (!content.error) {
                ...
                showToast(_orderingComponentsAdmin.ToastType.Success, t('RECOVERY_ACTION_DELETED', 'Recovery action deleted'));
                props.onClose && props.onClose();
              }
