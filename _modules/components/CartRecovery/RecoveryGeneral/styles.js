...
var ParentCheckBoxWrapper = exports.ParentCheckBoxWrapper = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  > div {\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n    width: fit-content;\n\n    svg {\n      font-size: 16px;\n      color: ", ";\n      &.checked-icon {\n        color: ", ";\n      }\n    }\n    \n    > span {\n      font-size: 14px;\n      line-height: 24px;\n      margin-left: 13px;\n      ", "\n    }\n  }\n"])), function (props) {
  ...
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n        margin-right: 13px;\n        margin-left: 0px;\n      "])));
});
var ChildCheckBoxWrapper = exports.ChildCheckBoxWrapper = (0, _styledComponents.default)(ParentCheckBoxWrapper)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  margin-bottom: 10px;\n"])));
var TimeContent = exports.TimeContent = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  padding: 15px 0px 10px 0px; \n"])));
...
var TimeBlock = exports.TimeBlock = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  border: 1px solid ", ";\n  box-sizing: border-box;\n  border-radius: 7.6px;\n  width: fit-content;\n  align-items: center;\n  overflow: hidden;\n\n  > span {\n    color: ", ";\n  }\n  \n  > select {\n    height: 40px;\n    padding: 0px 10px;\n    border: none;\n    outline: none;\n    font-size: 14px;\n    color: ", ";\n    appearance: none;\n  }\n"])), function (props) {
  return props.theme.colors.gray;
}, function (props) {
  var _props$theme4;
...
var ArrowIconsWrapper = exports.ArrowIconsWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  position: absolute;\n  height: 100%;\n  top: 0px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  padding: 7px 10px;\n  right: 0px;\n  ", "\n  svg {\n    color: ", ";\n    font-size: 12px;\n  }\n"])), function (props) {
  var _props$theme7;
...
var DateContent = exports.DateContent = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  padding: 15px 25px 10px 25px;\n"])));
var DateRangeContent = exports.DateRangeContent = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  position: relative;\n  > button {\n    border-radius: 8px;\n    height: 44px;\n    background-color: ", ";\n    color: ", ";\n    border: none;\n  \n    svg {\n      font-size: 16px;\n      margin-right: 12px;\n      color: ", ";\n      ", "\n    }\n  }\n"])), function (props) {
