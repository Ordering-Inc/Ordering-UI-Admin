...
var PointGroup = exports.PointGroup = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 0px 4px;\n  height: 100%;\n  > div {\n    width: 7px;\n    height: 7px;\n    min-width: 7px;\n    border-radius: 50%;\n    background-color: #CED4DA;\n    margin: 0px 4px;\n  }\n"])));
var EmailPreviewContent = exports.EmailPreviewContent = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  padding: 13px 30px;\n\n  > h2 {\n    margin-top: 0px;\n    margin-bottom: 10px;\n    text-align: center;\n    font-size: 10px;\n  }\n\n  > div {\n    zoom: 0.4;\n    overflow: auto;\n  }\n"])), function (props) {
  return props.theme.colors.primaryContrast;
});
var SmsPreviewWrapper = exports.SmsPreviewWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin: 0 auto;\n  background-color: ", ";\n  border-top-left-radius: 30px;\n  border-top-right-radius: 30px;\n  width: 212px;\n  padding: 20px 16px 0px 16px;\n"])), function (props) {
  return props.theme.colors.secundaryDarkContrast;
});
var NotificationPreviewWrapper = exports.NotificationPreviewWrapper = (0, _styledComponents.default)(SmsPreviewWrapper)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral([""])));
var NotificationPreviewLayout = exports.NotificationPreviewLayout = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
var SmsContentLayoutStyled = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n"])));
...
var NotificationContentHeaderStyled = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 51px;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n"])));
...
var NotificationContent = exports.NotificationContent = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  background-color: #EAE1D8;\n  padding: 9px;\n  height: 145px;\n  max-height: 145px;\n  overflow: auto;\n"])));
var SmsPreviewContentWrapper = exports.SmsPreviewContentWrapper = (0, _styledComponents.default)(NotificationContent)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  background-color: transparent;\n  width: 100%;\n  padding: 9px;\n  margin-top: 30px;\n  height: 165px;\n  max-height: 165px;\n  overflow: auto;\n"])));
var SmsPreviewContent = exports.SmsPreviewContent = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  margin: 10px 0px 0px 0px;\n  background: ", ";\n  border-radius: 7.6px;\n  padding: 10px;\n  height: fit-content;\n\n  > h2 {\n    font-size: 10px;\n    margin-top: 0px;\n    margin-bottom: 5px;\n  }\n  p {\n    font-size: 7px;\n    margin: 0px;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.secundary;
}, function (props) {
  return props.theme.colors.lightGray;
});
var NotificationMessageContent = exports.NotificationMessageContent = (0, _styledComponents.default)(SmsPreviewContent)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  height: fit-content;\n  margin: 20px 0px 0px 0px;\n"])));
var AddNewNotificationButton = exports.AddNewNotificationButton = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  padding-bottom: 15px;\n"])));