...
var Title = exports.Title = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  font-size: 20px;\n  font-weight: 700;\n  color: ", ";\n  text-align: initial;\n  text-transform: capitalize;\n  margin-bottom: 10px;\n"])), function (props) {
  return props.theme.colors.headingColor;
});
var CloseButtonWrapper = exports.CloseButtonWrapper = _styledComponents.default.span(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  position: fixed;\n  cursor: pointer;\n  top: 20px;\n  ", "\n"])), function (props) {
  var _props$theme3;
...
var WrapInput = exports.WrapInput = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n  &.address_notes {\n    width: 100%;\n  }\n\n  &.internal_number,\n  &.zipcode {\n    width: 100%;\n  }\n  @media (min-width: 621px) {\n    &.internal_number,\n    &.zipcode  {\n      width: 48%;\n    }\n  }\n"])));
var InputText = exports.InputText = _styledComponents.default.label(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  color: ", ";\n  font-size: 14px;\n  margin: 30px 0 7px 0;\n"])), function (props) {
  return props.theme.colors.headingColor;
});
var TagButton = exports.TagButton = _styledComponents.default.button(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  color: ", ";\n  border-radius: 8px;\n  outline: none;\n  background: transparent;\n  border: none;\n  font-size: 14px;\n  padding: 10px 15px;\n\n  ", "\n\n  svg {\n    font-size: 16px;\n    ", "\n  }\n"])), function (props) {
