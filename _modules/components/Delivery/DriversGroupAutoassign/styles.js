...
var MaxDistanceCustomerContainer = exports.MaxDistanceCustomerContainer = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 35px;\n\n  > div:first-child {\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    flex-wrap: wrap;\n    margin-bottom: 12px;\n\n    p {\n      margin-bottom: 0px;\n      &:first-child {\n        font-size: 14px;\n      }\n      &:not(:first-child) {\n        font-size: 12px;\n        color: ", ";\n      }\n    }\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
var RowGroupContainer = exports.RowGroupContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 20px;\n  > div {\n    width: calc(50% - 10px);\n  }\n"])));
var CheckboxWrapper = exports.CheckboxWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  ", "\n\n  span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (_ref5) {
  ...
  return isPadding && (0, _styledComponents.css)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    padding-bottom: 20px;\n  "])));
}, function (props) {
  var _props$theme3;
...
var FieldContainer = exports.FieldContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 25px;\n\n  label {\n    font-size: 14px;\n    margin-bottom: 12px;\n  }\n\n  ", "\n  ", "\n  ", "\n"])), function (_ref6) {
  var isPink = _ref6.isPink;
  return isPink && (0, _styledComponents.css)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n    input {\n      &:focus {\n        border-color: #ff0095;\n      }\n    }\n  "])));
}, function (_ref7) {
  var isGreen = _ref7.isGreen;
  return isGreen && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    input {\n      &:focus {\n        border-color: #0b720b;\n      }\n    }\n  "])));
}, function (_ref8) {
  var isBlue = _ref8.isBlue;
  return isBlue && (0, _styledComponents.css)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n    input {\n      &:focus {\n        border-color: ", ";\n      }\n    }\n  "])), function (props) {
    return props.theme.colors.primary;
  });
});
var InputsGroup = exports.InputsGroup = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  input {\n    width: 75px;\n  }\n\n  strong {\n    margin: 0 20px;\n  }\n"])));
var AreaWrapper = exports.AreaWrapper = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n  height: 70%;\n  margin: auto 0;\n"])));
var LargeArea = exports.LargeArea = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 100%;\n  border: 1px solid ", ";\n  border-radius: 50%;\n  position: absolute;\n\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref9) {
  var active = _ref9.active;
  return active && (0, _styledComponents.css)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n    border-color: #ff0095;\n  "])));
});
var MediumArea = exports.MediumArea = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  width: 70%;\n  height: 70%;\n  border: 1px solid ", ";\n  border-radius: 50%;\n  position: absolute;\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref0) {
  var active = _ref0.active;
  return active && (0, _styledComponents.css)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n    border-color: #0b720b;\n  "])));
});
var SmallArea = exports.SmallArea = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  width: 40%;\n  height: 40%;\n  border: 1px solid ", ";\n  border-radius: 50%;\n  position: absolute;\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref1) {
  var active = _ref1.active;
  return active && (0, _styledComponents.css)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n    border-color: ", ";\n  "])), function (props) {
    return props.theme.colors.primary;
  });
});
var CheckboxContainer = exports.CheckboxContainer = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  > div {\n    &:not(:first-child) {\n      margin-top: 5px;\n    }\n  }\n"])));