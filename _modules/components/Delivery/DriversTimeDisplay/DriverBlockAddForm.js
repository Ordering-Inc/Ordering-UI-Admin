...
var DriverBlockAddFormUI = exports.DriverBlockAddFormUI = function DriverBlockAddFormUI(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles2.FormWrapper, null, /*#__PURE__*/_react.default.createElement("span", null, t('BLOCK_NAME', 'Block Name')), /*#__PURE__*/_react.default.createElement(_Inputs.InputPrimary, {
    ...
    height: 34,
    width: 95
  })), showBreakBlock && /*#__PURE__*/_react.default.createElement(_styles2.SelectTitleWrappre, null, /*#__PURE__*/_react.default.createElement(_styles2.SelectTitle, null, t('END_BREAK_BLOCK_DATE', 'End break block date:')), scheduleOptionValues.includes(getHourOrMinute((_scheduleState$state$7 = scheduleState === null || scheduleState === void 0 || (_scheduleState$state0 = scheduleState.state) === null || _scheduleState$state0 === void 0 ? void 0 : _scheduleState$state0.break_end) !== null && _scheduleState$state$7 !== void 0 ? _scheduleState$state$7 : selectedBlock === null || selectedBlock === void 0 ? void 0 : selectedBlock.break_end, true)) || getHourOrMinute((_scheduleState$state$8 = scheduleState === null || scheduleState === void 0 || (_scheduleState$state1 = scheduleState.state) === null || _scheduleState$state1 === void 0 ? void 0 : _scheduleState$state1.break_end) !== null && _scheduleState$state$8 !== void 0 ? _scheduleState$state$8 : selectedBlock === null || selectedBlock === void 0 ? void 0 : selectedBlock.break_end) === scheduleOptionValues[(scheduleOptionValues === null || scheduleOptionValues === void 0 ? void 0 : scheduleOptionValues.length) - 1] ? /*#__PURE__*/_react.default.createElement(_styles2.SelectWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.DefaultSelect, {
    noSelected: true,
    options: scheduleOptions.filter(function (option) {
      return !['break_start', 'end', 'start'].includes(option === null || option === void 0 ? void 0 : option.name);
    }),
    defaultValue: getHourOrMinute((_scheduleState$state$9 = scheduleState === null || scheduleState === void 0 || (_scheduleState$state10 = scheduleState.state) === null || _scheduleState$state10 === void 0 ? void 0 : _scheduleState$state10.break_end) !== null && _scheduleState$state$9 !== void 0 ? _scheduleState$state$9 : selectedBlock === null || selectedBlock === void 0 ? void 0 : selectedBlock.break_end),
    onChange: function onChange(val) {
    ...
    color: "primary",
    borderRadius: "8px",
    disabled: scheduleState.loading || (isEdit ? false : !(scheduleState !== null && scheduleState !== void 0 && (_scheduleState$state11 = scheduleState.state) !== null && _scheduleState$state11 !== void 0 && _scheduleState$state11.until) && scheduleState.rrule),
    onClick: function onClick() {
