...
var UserDetailsUI = exports.UserDetailsUI = function UserDetailsUI(props) {
  var _configs$allow_driver, _configs$white_label_, _userState$user, _userState$user2, _userState$user3, _userState$user5, _userState$user7, _userState$user8, _userState$user9, _userState$user0, _userState$user1, _userState$user10, _scheduleState$change, _userState$user11, _userState$user12, _userState$user13, _userState$user14, _userState$user15, _userState$user16;
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles3.DetailsHeader, null, /*#__PURE__*/_react.default.createElement(_styles3.UserName, null, userState !== null && userState !== void 0 && userState.loading ? /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
    ...
    userId: (_userState$user0 = userState.user) === null || _userState$user0 === void 0 ? void 0 : _userState$user0.id,
    addresses: (_userState$user1 = userState.user) === null || _userState$user1 === void 0 ? void 0 : _userState$user1.addresses,
    ...
    scheduleList: userState === null || userState === void 0 || (_userState$user10 = userState.user) === null || _userState$user10 === void 0 ? void 0 : _userState$user10.schedule,
