...
exports.ChannelItem = exports.ChannelsContainer = exports.StackableContainer = exports.OrderPriorityContainer = exports.LabelWrapper = exports.SelectGroup = exports.CalendarWrapper = exports.CalendarContainer = exports.DateRangeWrapper = exports.InputWrapper = exports.UploadImageIcon = exports.UploadImageIconContainer = exports.Image = exports.PromotionImage = exports.FormInput = exports.DetailsContainer = void 0;
...
var PromotionImage = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  align-items: center;\n  width: 100%;\n  margin: 20px auto;\n\n  @media (min-width: 768px){\n    width: auto;\n  }\n"])));
...
var DateRangeWrapper = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  label {\n    margin-bottom: 10px;\n    font-size: 14px;\n  }\n"])));

exports.DateRangeWrapper = DateRangeWrapper;

var CalendarContainer = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  position: relative;\n  > button {\n    height: 43px;\n    span {\n      ", "\n    }\n  }\n"])), function (props) {
  var _props$theme;
...
var CalendarWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  background: #FFFFFF;\n  border: 1px solid ", ";\n  box-sizing: border-box;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n  z-index: 100;\n  position: absolute;\n  margin-top: 18px;\n  overflow: hidden;\n  ", "\n  .rdrDateRangeWrapper {\n    .rdrDateDisplayWrapper {\n      background-color: transparent;\n    }\n\n    .rdrDateDisplayItem {\n      border: 1px solid ", ";\n      box-shadow: none;\n    }\n\n    button {\n      ", "\n    }\n\n    .rdrDay:not(.rdrDayPassive) .rdrInRange ~ .rdrDayNumber span, .rdrDay:not(.rdrDayPassive) .rdrStartEdge ~ .rdrDayNumber span, .rdrDay:not(.rdrDayPassive) .rdrEndEdge ~ .rdrDayNumber span, .rdrDay:not(.rdrDayPassive) .rdrSelected ~ .rdrDayNumber span {\n      color: ", ";\n    }\n  }\n"])), function (props) {
...
var SelectGroup = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  margin-top: 24px;\n\n  > div {\n    width: calc(50% - 24px);\n  }\n"])));

exports.SelectGroup = SelectGroup;

var LabelWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  label {\n    font-size: 14px;\n    margin-bottom: 10px;\n    text-decoration: capitalize;\n  }\n"])));

exports.LabelWrapper = LabelWrapper;

var OrderPriorityContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  margin-top: 24px;\n  display: flex;\n  flex-direction: column;\n\n  label {\n    font-size: 14px;\n    margin-bottom: 10px;\n  }\n  .select {\n    font-size: 14px;\n    background: ", ";\n    border: none;\n    > div:first-child {\n      padding-top: 5px;\n      padding-bottom: 5px;\n    }\n    .list {\n      > div {\n        white-space: nowrap;\n      }\n    }\n  }\n"])), function (props) {
  return props.theme.colors.secundary;
});

exports.OrderPriorityContainer = OrderPriorityContainer;

var StackableContainer = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  margin-top: 24px;\n\n  > span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var ChannelsContainer = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  margin-top: 36px;\n\n  p {\n    margin: 0;\n    font-size: 16px;\n    font-weight: 600;\n    padding-bottom: 14px;\n    border-bottom: 1px solid ", ";\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
});

exports.ChannelsContainer = ChannelsContainer;

var ChannelItem = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  padding: 12px 0;\n  border-bottom: 1px solid ", ";\n  display: flex;\n  align-items: center;\n\n  span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme4;
