...
var OnboardingLessonsContainer = _styledComponents.default.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  padding: 50px 15px;\n  margin: 20px 0;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  h1 {\n    font-size: 24px;\n    font-weight: 700;\n    line-height: 36px;\n    text-align: center;\n  }\n  p {\n    font-size: 16px;\n    font-weight: 500;\n    line-height: 24px;\n    text-align: center;\n    margin: 8px 0 17px 0;\n  }\n  button {\n    border-radius: 7.6px;\n    padding: 10px;\n    line-height: 20px;\n    min-width: 216px;\n  }\n"])), function (props) {
  return props.theme.colors.lightPrimary;
});
exports.OnboardingLessonsContainer = OnboardingLessonsContainer;