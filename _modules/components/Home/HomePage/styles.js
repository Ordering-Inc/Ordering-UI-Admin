...
var OrderingButtonWrapper = _styledComponents.default.div(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: calc(100% - 125px);\n  top: 0;\n  right: 0;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  background-color: ", ";\n  padding: 14px 24px;\n  border: 2px solid ", ";\n  border-radius: 8px;\n  margin-left: 30px;\n  ", "\n\n  span {\n    color: ", ";\n    font-weight: 700;\n    font-size: 20px;\n  }\n\n  button {\n    height: 44px;\n    width: 180px;\n    margin: 0;\n    border-radius: 8px;\n  }\n\n  @media (min-width: 800px) {\n    button {\n      margin-right: 76px;\n      ", "\n    }\n  }\n\n  @media (min-width: 1200px) {\n    width: calc(100% - 130px);\n    button {\n      width: 216px;\n    }\n  }\n\n  @media (min-width: 1440px) {\n    button {\n      margin-right: 156px;\n      ", "\n    }\n  }\n"])), function (props) {
...
exports.OrderingButtonWrapper = OrderingButtonWrapper;
var OrderingButtonBlock = _styledComponents.default.div(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 7.6px;\n  padding: 42px 20px;\n  margin-bottom: 42px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  h2 {\n    font-weight: 700;\n    font-size: 24px;\n    margin: 0;\n    text-align: center;\n    span {\n      color: ", ";\n    }\n  }\n  button {\n    margin-top: 22px;\n    width: 214px;\n    height: 44px;\n    border-radius: 8px;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
exports.OrderingButtonBlock = OrderingButtonBlock;
var CloseButtonWrapper = _styledComponents.default.div(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n  position: sticky;\n  top: 100%;\n  display: flex;\n  justify-content: center;\n  margin-top: 20px;\n\n  button {\n    height: 44px;\n    border-radius: 8px;\n    width: 100%;\n  }\n"])));
exports.CloseButtonWrapper = CloseButtonWrapper;
var HubspotFormWrapper = _styledComponents.default.div(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  min-height: 445px;\n  position: relative;\n"])));
