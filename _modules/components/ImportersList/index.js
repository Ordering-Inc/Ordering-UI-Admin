...
var ImportersList = function ImportersList(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.ImportListContainer, null, /*#__PURE__*/_react.default.createElement(_styles.ImportersTableWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.ImpotersTable, null, /*#__PURE__*/_react.default.createElement("thead", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("th", null, t('NAME', 'Name')), /*#__PURE__*/_react.default.createElement("th", {
    colSpan: 2
    ...
    })), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement(_styles.UserEnableWrapper, {
    ...
    return /*#__PURE__*/_react.default.createElement("tr", {
      ...
      className: "importer-name"
    }, importer === null || importer === void 0 ? void 0 : importer.name)), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement(_styles.UserEnableWrapper, {
      className: "importer_enable_control"
    ...
    colSpan: "2"
  }, /*#__PURE__*/_react.default.createElement(_styles.NotFoundWrapper, null, /*#__PURE__*/_react.default.createElement(_NotFoundSource.NotFoundSource, {
    content: t('NOT_FOUND_IMPOTERS', "Can't found importers")
  })))))))), /*#__PURE__*/_react.default.createElement(_styles.ImportersBottomContainer, null, /*#__PURE__*/_react.default.createElement(_styles.AddNewImporterButton, {
    onClick: function onClick() {
      return addNewImporter();
    }
  }, t('ADD_NEW_IMPORTER', 'Add new importer')), (importerList === null || importerList === void 0 ? void 0 : importerList.importers.length) > 0 && /*#__PURE__*/_react.default.createElement(_styles.WrapperPagination, null, /*#__PURE__*/_react.default.createElement(_Pagination.Pagination, {
