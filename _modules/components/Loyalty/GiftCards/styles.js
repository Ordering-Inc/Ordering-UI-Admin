...
var ProductName = exports.ProductName = _styledComponents.default.span(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  font-weight: 500;\n  ", "\n"])), function (props) {
  var _props$theme3;
...
var BottomContainer = exports.BottomContainer = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: calc(100% - 10px);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n  margin: 20px 0;\n\n  button {\n    height: 44px;\n  }\n"])));
var NotFoundSourceWrapper = exports.NotFoundSourceWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  > div {\n    height: initial;\n    padding: 20px;\n  }\n"])));
var PriceWrapper = exports.PriceWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  span {\n    margin: 0 10px;\n    font-weight: 500;\n    font-size: 14px;\n  }\n"])));
var HeaderContainer = exports.HeaderContainer = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  ", "\n"])), function (props) {
  var _props$theme4;
...
var RequireDescription = exports.RequireDescription = _styledComponents.default.p(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  margin-top: 2px;\n  line-height: 21px;\n  font-size: 14px;\n  margin-bottom: 30px;\n"])));