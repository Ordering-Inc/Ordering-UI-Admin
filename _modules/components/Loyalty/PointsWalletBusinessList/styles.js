...
var WrapperImage = exports.WrapperImage = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  max-width: 38px;\n  min-width: 38px;\n  max-height: 38px;\n  height: 38px;\n  width: 38px;\n\n  ", "\n  border-radius: 8px;\n\n  > svg {\n    width: 100%;\n    height: 100%;\n  }\n"])), function (_ref2) {
...
var ModifiedWrapper = exports.ModifiedWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-direction: row-reverse;\n\n  svg {\n    font-size: 17px;\n    color: ", ";\n  }\n\n  ", "\n"])), function (props) {
  return props.theme.colors.secundaryLight;
}, function (_ref3) {
...
var CheckBoxInnerWrapper = exports.CheckBoxInnerWrapper = _styledComponents.default.span(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  ", "\n"])), function (_ref4) {
  var noClick = _ref4.noClick;
  return noClick && (0, _styledComponents.css)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});