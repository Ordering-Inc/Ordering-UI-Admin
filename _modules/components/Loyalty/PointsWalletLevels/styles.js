...
var LevelName = exports.LevelName = _styledComponents.default.span(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var LevelBottomContainer = exports.LevelBottomContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  width: calc(100% - 10px);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n  row-gap: 10px;\n  margin: 15px 0;\n"])));
var AddNewLevelButton = exports.AddNewLevelButton = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  font-size: 14px;\n  color: ", ";\n  user-select: none;\n"])), function (props) {
  return props.theme.colors.primary;
});
var NotFoundSourceWrapper = exports.NotFoundSourceWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  > div {\n    height: initial;\n    padding: 20px;\n  }\n"])));