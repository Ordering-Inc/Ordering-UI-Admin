...
var AudienceWrapper = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  > h2 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin-top: 0px;\n    margin-bottom: 15px;\n  }\n"])));

exports.AudienceWrapper = AudienceWrapper;

var DynamicWrapper = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  border-top: 1px solid ", ";\n  border-bottom: 1px solid ", ";\n  padding: 12px 0px;\n"])), function (props) {
...
var RadioCheckWrapper = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n\n  ", "\n\n  svg {\n    margin-right: 15px;\n    ", "\n    color: ", ";\n    &.fill {\n      color: ", ";\n    }\n  }\n\n  span {\n    user-select: none;\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n  }\n"])), function (_ref) {
...
var SwitchWrapper = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 22px;\n\n  > .campaign-enabled {\n    margin-bottom: 0px;\n    font-size: 14px;\n    line-height: 24px;\n    margin-right: 7px;\n    ", "\n  }\n"])), function (props) {
...
var DynamicContentWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  padding-left: 30px;\n\n  ", "\n\n  > p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-top: 5px;\n    margin-bottom: 0px;\n    color: ", ";\n\n    span {\n      color: ", ";\n    }\n  }\n"])), function (props) {
...
var FixedWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  padding: 12px 0px;\n  border-bottom: 1px solid ", ";\n"])), function (props) {
  return props.theme.colors.borderColor;
});

exports.FixedWrapper = FixedWrapper;

var FixedContent = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  padding-left: 30px;\n\n  ", "\n  > p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-top: 5px;\n    margin-bottom: 0px;\n    color: ", ";\n  }\n  h3 {\n    font-weight: 500;\n    font-size: 14px;\n    line-height: 21px;\n    margin-top: 20px;\n    margin-bottom: 17px;\n  }\n"])), function (props) {
...
var FixedStatusWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 18px;\n\n  > span {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    text-transform: capitalize;\n  }\n"])));

exports.FixedStatusWrapper = FixedStatusWrapper;

var StatusPoint = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  width: 14px;\n  height: 14px;\n  border-radius: 50%;\n  background-color: #FFC700;\n  margin: 0px 13px;\n"])));

exports.StatusPoint = StatusPoint;

var ScheduleForLateWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  padding-left: 30px;\n  padding-top: 18px;\n\n  ", "\n"])), function (props) {
