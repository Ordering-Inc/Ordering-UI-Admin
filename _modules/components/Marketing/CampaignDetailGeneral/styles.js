...
var SwitchWrapper = exports.SwitchWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 22px;\n\n  > .campaign-enabled {\n    margin-bottom: 0px;\n    font-size: 14px;\n    line-height: 24px;\n    margin-right: 7px;\n    ", "\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n      margin-left: 7px;\n      margin-right: 0px;\n    "])));
});
var DynamicContentWrapper = exports.DynamicContentWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  padding-left: 30px;\n\n  ", "\n\n  > p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-top: 5px;\n    margin-bottom: 0px;\n    color: ", ";\n\n    span {\n      color: ", ";\n    }\n  }\n"])), function (props) {
...
var FixedWrapper = exports.FixedWrapper = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  padding: 12px 0px;\n  border-bottom: 1px solid ", ";\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var FixedContent = exports.FixedContent = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  padding-left: 30px;\n\n  ", "\n  > p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-top: 5px;\n    margin-bottom: 0px;\n    color: ", ";\n  }\n  h3 {\n    font-weight: 500;\n    font-size: 14px;\n    line-height: 21px;\n    margin-top: 20px;\n    margin-bottom: 17px;\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n    padding-right: 30px;\n    padding-left: 0px;\n  "])));
}, function (props) {
  return props.theme.colors.lightGray;
});
var FixedStatusWrapper = exports.FixedStatusWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 18px;\n\n  > span {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    text-transform: capitalize;\n  }\n"])));
var StatusPoint = exports.StatusPoint = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  width: 14px;\n  height: 14px;\n  border-radius: 50%;\n  background-color: #FFC700;\n  margin: 0px 13px;\n"])));
var ScheduleForLateWrapper = exports.ScheduleForLateWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  padding-left: 30px;\n  padding-top: 18px;\n\n  ", "\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    padding-right: 30px;\n    padding-left: 0px;\n  "])));
});
var ButtonWrapper = exports.ButtonWrapper = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  position: sticky;\n  top: 100%;\n  padding-bottom: 15px;\n\n  button {\n    margin-top: 20px;\n    height: 44px;\n    border-radius: 8px;\n  }\n"])));
var RulesWrapper = exports.RulesWrapper = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin-top: 35px;\n\n  > h2 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin: 0px;\n    margin-bottom: 5px;\n  }\n  > p {\n    font-weight: 400;\n    margin: 0px;\n    font-size: 12px;\n    line-height: 18px;\n    margin-bottom: 5px;\n    span {\n      color: ", ";\n    }\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
var CheckBoxListWrapper = exports.CheckBoxListWrapper = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n"])));
var CheckBoxWrapper = exports.CheckBoxWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  padding: 12px 0px;\n  border-bottom: 1px solid ", ";\n  ", "\n  justify-content: space-between;\n  > div {\n    display: flex;\n    align-items: center;\n    .rule-control {\n      svg {\n        color: ", ";\n        &.fill {\n          color: ", ";\n        }\n      }\n    }\n    p {\n      font-weight: 400;\n      font-size: 14px;\n      line-height: 24px;\n      margin: 0px 0px 0px 20px;\n\n      ", "\n    }\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref2) {
...
var EndDateWrapper = exports.EndDateWrapper = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  margin-top: 10px;\n  span {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n  }\n\n  > div {\n    margin-top: 5px;\n  }\n"])));