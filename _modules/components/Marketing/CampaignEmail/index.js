...
var CampaignEmail = function CampaignEmail(props) {
  ...
  var handleChangeInput = function handleChangeInput(evt) {
    setEmail(_objectSpread(_objectSpread({}, email), {}, _defineProperty({}, evt.target.name, evt.target.value)));
  };

  var handleSaveEmail = function handleSaveEmail() {
    if (!(email !== null && email !== void 0 && email.title)) {
      setAlertState({
        open: true,
    ...
    if (!(email !== null && email !== void 0 && email.body)) {
      setAlertState({
        open: true,
  ...
  (0, _react.useEffect)(function () {
    ...
    if (contactData) setEmail(_objectSpread({}, contactData));
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles2.Container, null, /*#__PURE__*/_react.default.createElement(_styles2.InputWrapper, null, /*#__PURE__*/_react.default.createElement("label", null, t('TITLE', 'Title')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    ...
    defaultValue: (email === null || email === void 0 ? void 0 : email.title) || '',
