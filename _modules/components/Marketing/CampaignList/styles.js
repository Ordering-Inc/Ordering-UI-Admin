...
exports.Tbody = exports.Table = exports.SwitchWrapper = exports.StatusWrapper = exports.StatusPoint = exports.PagesBottomContainer = exports.Container = exports.AddNewPageButton = void 0;
...
var Container = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  max-height: calc(100vh - 410px);\n  overflow: auto;\n\n  ", "\n\n  @media (min-width: 768px) {\n    max-height: calc(100vh - 385px);\n  }\n\n  @media (min-width: 992px) {\n    max-height: calc(100vh - 305px);\n    ", "\n  }\n\n  @media (min-width: 1200px) {\n    max-height: calc(100vh - 273px);\n    ", "\n  }\n\n  ", "\n"])), function (_ref) {
  ...
  return isDisabledFeature && (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    opacity: 0.5;\n    cursor: not-allowed;\n    > table {\n      pointer-events: none;\n    }\n  "])));
});
...
var Table = _styledComponents.default.table(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  width: calc(100% - 10px);\n  min-width: 700px;\n\n  th,\n  td {\n    padding: 15px;\n    box-sizing: border-box;\n    font-size: 14px;\n\n    &:first-child {\n      padding-left: 0px;\n      padding-right: 0px;\n    }\n    &.action {\n      padding-left: 0px;\n      padding-right: 0px;\n    }\n  }\n\n  td {\n    &.right-border {\n      height: 0px;\n      > div {\n        padding: 5px 0px;\n        width: 100%;\n        height: 100%;\n        ", "\n      }\n    }\n  }\n\n  th {\n    padding-top: 0px;\n    font-weight: 700;\n    font-size: 12px;\n    padding: 5px 15px;\n    &.allow-colums {\n      width: 50px;\n    }\n  }\n\n  thead {\n    tr {\n      width: 100%;\n      border-bottom: solid 1px ", ";\n      th {\n        color: ", ";\n        white-space: nowrap;\n        z-index: 100;\n        background: ", ";\n      }\n    }\n  }\n\n  ", "\n\n  p {\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    margin: 0px;\n    &.bold {\n      font-weight: 500;\n    }\n  }\n"])), function (props) {
  ...
  var isRelative = _ref5.isRelative;
  return isRelative && (0, _styledComponents.css)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n    thead {\n      tr {\n        th {\n          position: sticky;\n          top: 0px;\n        }\n      }\n    }\n  "])));
});
...
var Tbody = _styledComponents.default.tbody(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n  cursor: pointer;\n\n  &:hover {\n    background: ", ";\n  }\n  &.active {\n    background-color: ", ";\n    td {\n      border-top: 1px solid ", " !important;\n      border-bottom: 1px solid ", " !important;\n\n      ", "\n    }\n  }\n"])), function (props) {
  ...
  var isCustomStyle = _ref6.isCustomStyle;
...
var StatusWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  p {\n    text-transform: capitalize;\n    margin-right: 12px;\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    ", "\n  }\n"])), function (props) {
...
var StatusPoint = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  width: 14px;\n  height: 14px;\n  border-radius: 50%;\n  background-color: #E9ECEF;\n"])));
...
var AddNewPageButton = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  font-size: 14px;\n  color: ", ";\n\n  &:hover {\n    color: ", ";\n  }\n\n  ", "\n"])), function (props) {
  ...
  var isDisabledFeature = _ref7.isDisabledFeature;
  return isDisabledFeature && (0, _styledComponents.css)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n    opacity: 0.5;\n    cursor: not-allowed;\n    &:hover {\n      color: ", ";\n    }\n  "])), function (props) {
    return props.theme.colors.lightGray;
  });
});
