...
var CampaignNotification = function CampaignNotification(props) {
  ...
  var handleChangeInput = function handleChangeInput(evt) {
    setNotification(_objectSpread(_objectSpread({}, notification), {}, _defineProperty({}, evt.target.name, evt.target.value)));
  };
  ...
  var handleSaveNotification = function handleSaveNotification() {
    ...
    if (!(notification !== null && notification !== void 0 && notification.body)) {
      setAlertState({
        open: true,
  ...
  (0, _react.useEffect)(function () {
    ...
    if (contactData) setNotification(_objectSpread({}, contactData));
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles2.Container, null, /*#__PURE__*/_react.default.createElement(_styles2.InputWrapper, null, /*#__PURE__*/_react.default.createElement("label", null, t('TITLE', 'Title')), /*#__PURE__*/_react.default.createElement(_styles.Input, {
    ...
    defaultValue: (notification === null || notification === void 0 ? void 0 : notification.title) || '',
    ...
    defaultValue: (notification === null || notification === void 0 ? void 0 : notification.body) || '',
    onChange: handleChangeInput
