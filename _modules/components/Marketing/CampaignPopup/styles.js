...
var HeaderWrapper = exports.HeaderWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  margin-bottom: 20px;\n\n  > h1 {\n    font-weight: 600;\n    font-size: 14px;\n    line-height: 21px;\n    margin: 0px;\n  }\n\n  svg {\n    min-width: 16px;\n    font-size: 16px;\n    margin-left: 10px;\n\n    ", "\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n      margin-left: 0px;\n      margin-right: 10px;\n    "])));
});
var PopupButtonWrapper = exports.PopupButtonWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin-top: 50px;\n  button {\n    width: 100%;\n  }\n"])));