...
var CampaignSMS = function CampaignSMS(props) {
  ...
  var handleChangeInput = function handleChangeInput(evt) {
    setSms(_objectSpread(_objectSpread({}, sms), {}, _defineProperty({}, evt.target.name, evt.target.value)));
  };

  var handleSaveSms = function handleSaveSms() {
    if (!(sms !== null && sms !== void 0 && sms.title)) {
      setAlertState({
        open: true,
    ...
    if (!(sms !== null && sms !== void 0 && sms.body)) {
      setAlertState({
        open: true,
  ...
  (0, _react.useEffect)(function () {
    ...
    if (contactData) setSms(_objectSpread({}, contactData));
