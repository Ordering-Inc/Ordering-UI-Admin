...
var WhatsAppPreviewWrapper = exports.WhatsAppPreviewWrapper = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  margin: 0 auto;\n  background-color: ", ";\n  border-top-left-radius: 30px;\n  border-top-right-radius: 30px;\n  width: 212px;\n  padding: 20px 16px 0px 16px;\n"])), function (props) {
...
var WhatsAppPreviewLayout = exports.WhatsAppPreviewLayout = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
...
var WhatsAppContentHeader = exports.WhatsAppContentHeader = function WhatsAppContentHeader(props) {
...
var WhatsAppContent = exports.WhatsAppContent = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  background-color: #EAE1D8;\n  padding: 9px;\n  height: 145px;\n  max-height: 145px;\n  overflow: auto;\n"])));
var WhatsAppMessageContent = exports.WhatsAppMessageContent = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  margin: 20px 0px 0px 0px;\n  background: ", ";\n  border-radius: 7.6px;\n  padding: 10px;\n  height: fit-content;\n\n  > h2 {\n    font-size: 10px;\n    margin-top: 0px;\n    margin-bottom: 5px;\n  }\n  p {\n    font-size: 7px;\n    margin: 0px;\n    color: ", ";\n  }\n"])), function (props) {
