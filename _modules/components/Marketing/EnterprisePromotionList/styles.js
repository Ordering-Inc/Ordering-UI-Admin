...
var SinglePromotionTbody = _styledComponents.default.tbody(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n  cursor: pointer;\n  &:hover {\n    background-color: ", ";\n  }\n  &.active {\n    background-color: ", ";\n    td {\n      border-top: 1px solid ", ";\n      border-bottom: 1px solid ", ";\n    }\n  }\n\n  ", "\n"])), function (props) {
  ...
  return isAccept && (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
...
var EnableWrapper = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n\n  span {\n    font-size: 12px;\n\n    ", "\n  }\n"])), function (props) {
  var _props$theme;
...
var PromotionListBottom = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 10px;\n  ", "\n"])), function (_ref4) {
  var eventDisabled = _ref4.eventDisabled;
  return eventDisabled && (0, _styledComponents.css)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});

exports.PromotionListBottom = PromotionListBottom;

var AddNewButton = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  color: ", ";\n  width: fit-content;\n  font-size: 13px;\n  &:hover {\n    color: ", ";\n  }\n"])), function (props) {
...
var DummyImageWrapper = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  height: 40px;\n  width: 40px;\n  background-color: rgb(0 0 0 / 20%);\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  svg {\n    color: ", ";\n    font-size: 18px;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
