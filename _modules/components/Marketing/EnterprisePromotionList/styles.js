...
var EnableWrapper = exports.EnableWrapper = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n\n  span {\n    font-size: 12px;\n\n    ", "\n  }\n"])), function (props) {
  var _props$theme;
  return (_props$theme = props.theme) !== null && _props$theme !== void 0 && _props$theme.rtl ? (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n      padding-left: 10px;\n    "]))) : (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n      padding-right: 10px;\n    "])));
});
var DragableContainer = exports.DragableContainer = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  > div:first-child {\n    display: flex;\n    align-items: center;\n  \n    > span {\n      font-weight: 500;\n      flex: 1;\n    }\n  }\n"])));
var DragImageWrapper = exports.DragImageWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  img {\n    ", "\n    &:hover {\n      cursor: grab;\n    }\n  }\n\n  span {\n    ", "\n  }\n"])), function (props) {
  var _props$theme2;
...
var VerticalLine = exports.VerticalLine = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  width: 1px;\n  height: 38px;\n  background-color: ", ";\n  margin: 0 20px;\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var PromotionDateRanageWrapper = exports.PromotionDateRanageWrapper = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  p {\n    margin: 0;\n  }\n"])));
var PromotionTypeWrapper = exports.PromotionTypeWrapper = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"])));
var PromotionHow = exports.PromotionHow = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"])));
var PromotionListBottom = exports.PromotionListBottom = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-top: 10px;\n  margin-bottom: 38px;\n  @media (max-width: 450px) {\n    > div {\n      margin-bottom: 5px;\n    }\n  }\n  ", "\n"])), function (_ref7) {
...
var WrapperPagination = exports.WrapperPagination = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n"])));
var DummyImageWrapper = exports.DummyImageWrapper = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  height: 40px;\n  width: 40px;\n  background-color: rgb(0 0 0 / 20%);\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  svg {\n    color: ", ";\n    font-size: 18px;\n  }\n"])), function (props) {
