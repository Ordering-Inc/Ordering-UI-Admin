...
var WrapperPagination = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n"])));
exports.WrapperPagination = WrapperPagination;
var DummyImageWrapper = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  height: 40px;\n  width: 40px;\n  background-color: rgb(0 0 0 / 20%);\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  svg {\n    color: ", ";\n    font-size: 18px;\n  }\n"])), function (props) {
