...
var OrdersOrderByOptionContainer = exports.OrdersOrderByOptionContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  padding: 15px 0 35px;\n  display: flex;\n  overflow-x: auto;\n\n  button {\n    ", "\n    font-size: 14px;\n    white-space: nowrap;\n\n    svg {\n      font-size: 20px;\n\n      ", "\n    }\n  }\n"])), function (props) {
  var _props$theme2;
...
var MessageContainer = exports.MessageContainer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  border: 1px solid ", ";\n  height: 80vh;\n  border-radius: 8px;\n  overflow: hidden;\n  margin-top: 20px;\n  \n  @media (min-width: 1024px) {\n    margin-top: 0px;\n    height: 100%;\n    flex: 1;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme4;
...
var ContactsContainer = exports.ContactsContainer = (0, _styledComponents.default)(OrdersOrderByOptionContainer)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n"])));
var InnerTabsContainer = exports.InnerTabsContainer = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n"])));