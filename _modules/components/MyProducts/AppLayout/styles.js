...
var DownloadLink = exports.DownloadLink = _styledComponents.default.a(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  text-decoration: underline;\n"])));
var ButtonWRapper = exports.ButtonWRapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-direction: column;\n  padding-top: 15px;\n  button {\n    height: 44px;\n    width: 100%;\n    margin-top: 16px;\n  }\n\n  @media (min-width: 768px) {\n    flex-direction: row;\n    button {\n      width: calc(50% - 10px);\n    }\n  }\n"])));
var DownLoadWrapper = exports.DownLoadWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  img {\n    cursor: pointer;\n    &:last-child {\n      margin: 0px 15px;\n    }\n  }\n"])));
var HeaderInfoWrapper = exports.HeaderInfoWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  position: relative;\n  ", "\n\n  > button {\n    height: 25px;\n    svg {\n      width: 16px;\n      height: 16px;\n    }\n  }\n  &:hover > div {\n    visibility: visible;\n    opacity: 1;\n  }\n"])), function (props) {
  var _props$theme2;
