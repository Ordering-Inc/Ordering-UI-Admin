...
var ProductListTable = exports.ProductListTable = _styledComponents.default.table(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  width: 100%;\n  min-width: 800px;\n\n  thead {\n    border-bottom: 1px solid ", ";\n    th {\n      padding: 10px 0;\n      font-size: 12px;\n    }\n  }\n\n  tr {\n    display: flex;\n    align-items: center;\n    th, td {\n      &.product {\n        width: 25%\n      }\n    }\n    td {\n      &.product {\n        font-size: 14px;\n        font-weight: 500;\n      }\n      &.description {\n        font-size: 12px;\n        line-height: 15px;\n        color: ", ";\n      }\n    }\n  }\n\n  th.description,\n  td.description {\n    ", "\n  }\n"])), function (props) {
...
var PageTbody = exports.PageTbody = _styledComponents.default.tbody(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  border-bottom: 1px solid ", ";\n\n  td {\n    padding: 16px 0;\n    input {\n      border: none;\n      width: 100%;\n      padding: 3px 0;\n      outline: none;\n      &:focus {\n        border: 1px solid ", ";\n      }      \n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", "\n"])), function (props) {
...
var PagesBottomContainer = exports.PagesBottomContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n  row-gap: 10px;\n  margin: 15px 0;\n"])));
