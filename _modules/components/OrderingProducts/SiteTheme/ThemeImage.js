...
var ThemeImage = exports.ThemeImage = function ThemeImage(props) {
  ...
  var handleChangePhoto = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(croppedImg) {
      var _yield$handleAddTheme, error, result, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            _yield$handleAddTheme = _context.v;
