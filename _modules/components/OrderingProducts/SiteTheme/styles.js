...
var ComponentHeader = exports.ComponentHeader = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-bottom: 8px;\n  > input {\n    ", "\n  }\n"])), function (props) {
  var _props$theme2;
...
var OptionContainer = exports.OptionContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  margin: 15px 0;\n  border: 1px solid ", ";\n  border-radius: 8px;\n  padding: 10px;\n  h5 {\n    font-size: 12px;\n    margin: 0;\n    text-transform: capitalize;\n  }\n  > input {\n    width: 100%;\n  }\n  .select-wrapper,\n  > input {\n    margin-top: 8px;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var OptionHeader = exports.OptionHeader = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  > input {\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var UpdateButtonWrapper = exports.UpdateButtonWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  padding-top: 20px;\n  button {\n    height: 42px;\n  }\n"])));
var ColorPickerContainer = exports.ColorPickerContainer = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  margin-top: 8px;\n"])));
...
var ComponentImage = exports.ComponentImage = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  height: 160px;\n  width: 160px;\n  overflow: hidden;\n  cursor: -webkit-grab;\n  cursor: grab;\n  background: ", ";\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n\n  ", "\n\n  img,\n  div {\n    width: 100%;\n    border-radius: 7.6px;\n    height: 100%;\n    overflow: hidden;\n    position: relative;\n  };\n\n  img{\n    object-fit: contain;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref2) {
  var isMarginTop = _ref2.isMarginTop;
  return isMarginTop && (0, _styledComponents.css)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n    margin-top: 10px;\n  "])));
});
var PageSelectWrapper = exports.PageSelectWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  padding: 20px 0 30px 0;\n"])));
var PageHiddenCheckWrapper = exports.PageHiddenCheckWrapper = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-bottom: 15px;\n\n  > input {\n    ", "\n  }\n  h4 {\n    font-size: 12px;\n    margin: 0px;\n    text-transform: capitalize;\n  }\n"])), function (props) {
  var _props$theme4;
