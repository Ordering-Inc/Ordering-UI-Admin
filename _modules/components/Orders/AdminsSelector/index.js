...
var AdminsSelector = exports.AdminsSelector = function AdminsSelector(props) {
  ...
  (0, _react.useEffect)(function () {
    var _adminsOptionList = [{
      value: 'default',
      content: /*#__PURE__*/_react.default.createElement(_styles.Option, {
        padding: "0px"
      }, /*#__PURE__*/_react.default.createElement("span", null, t('SELECT_ADMINISTRATOR', 'Select the administrator'))),
      color: 'primary',
      showDisable: true
    }];
    if (adminsList && !adminsList.loading) {
      var _adminList;
      if (searchValue) {
        _adminList = adminsList.admins.filter(function (admin) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, adminsList && !adminsList.loading ? /*#__PURE__*/_react.default.createElement(_MultiSelect.MultiSelect, {
