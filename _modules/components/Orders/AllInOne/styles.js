...
var OrderStatusSubFilterWrapper = exports.OrderStatusSubFilterWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: inline-block;\n  ", "\n  ", "\n"])), function (props) {
  var _props$theme;
...
var HeaderTitleContainer = exports.HeaderTitleContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  align-items: center;\n  h1 {\n    color: ", ";\n    font-size: 20px;\n    font-weight: 700;\n    line-height: 30px;\n    margin: 0px;\n    text-transform: capitalize;\n  }\n  > button {\n    ", "\n    svg {\n      width: 25px;\n      height: 25px;\n    }\n  }\n"])), function (props) {
...
var MainContentContainer = exports.MainContentContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  margin-top: 15px;\n"])));
var TopContent = exports.TopContent = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column-reverse;\n  margin-bottom: 20px;\n  border-bottom: 5px solid ", ";\n  @media (min-width: 992px) {\n    flex-direction: row;\n    #orderTable {\n      max-height: calc(var(--vh, 1vh) * 50 - 180px);\n    }\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var WrapperDriversLocation = exports.WrapperDriversLocation = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  border-radius: 8px;\n  overflow: hidden;\n  height: calc(var(--vh, 1vh) * 100 - 40px);\n\n  @media (min-width: 992px) {\n    height: calc(var(--vh, 1vh) * 50 - 115px);\n  }\n"])));
var DriversContainer = exports.DriversContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  @media (min-width: 992px) {\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var OrdersContainer = exports.OrdersContainer = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  box-sizing: border-box;\n  ", "\n  @media (min-width: 992px) {\n    width: calc(100% - 355px);\n  }\n"])), function (props) {
  var _props$theme4;
