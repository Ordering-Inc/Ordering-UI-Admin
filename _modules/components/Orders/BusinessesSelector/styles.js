...
var PlaceholderTitle = (0, _styledComponents.default)(Option)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  padding: 10px;\n"])));
exports.PlaceholderTitle = PlaceholderTitle;

var OptionContent = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n"])));

exports.OptionContent = OptionContent;

var OptionName = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  color: #263238;\n  font-size: 16px;\n  line-height: 1.3;\n"])));

exports.OptionName = OptionName;

var OptionCategory = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  color: #263238;\n  font-size: 12px;\n  line-height: 1.3;\n"])));

exports.OptionCategory = OptionCategory;

var WrapperBusinessImage = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  width: 45px;\n  height: 45px;\n  border: 1px solid #E3E3E3;\n  border-radius: 10px;\n\n  svg {\n    width: 100%;\n    height: 100%;\n    padding: 5px;\n    box-sizing: border-box;\n    border-radius: 50%;\n  }\n"])));
