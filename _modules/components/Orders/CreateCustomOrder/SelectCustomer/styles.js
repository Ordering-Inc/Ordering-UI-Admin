...
var OptionsToSelectContainer = exports.OptionsToSelectContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 50px;\n  left: 0;\n  width: 100%;\n  max-height: 300px;\n  overflow-x: hidden;\n  border-radius: 8px;\n  border: 1px solid ", ";\n  background-color: ", ";\n  padding: 9px 0;\n\n  > p {\n    font-size: 12px;\n    margin: 0 16px;\n\n    > span.new {\n      cursor: pointer;\n      color: ", ";\n      &:hover {\n        text-decoration: underline;\n      }\n    }\n  }\n"])), function (props) {
...
var SelectOption = exports.SelectOption = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  position: relative;\n  cursor: pointer;\n  width: 100%;\n  padding: 9px 16px;\n  display: flex;\n  align-items: center;\n\n  &:hover {\n    background-color: ", ";\n  }\n  span {\n    font-size: 14px;\n    &.name {\n      overflow: hidden;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n    }\n  }\n\n  button {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    position: absolute;\n    background: ", ";\n    width: 20px;\n    height: 20px;\n    transform: translate(100%, -50%);\n    top: 11px;\n    right: 20px;\n  }\n"])), function (props) {
...
var SelectedUserWrapper = exports.SelectedUserWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  border-radius: 8px;\n  border: 1px solid ", ";\n  height: 44px;\n  display: flex;\n  align-items: center;\n  flex: 1;\n\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme4;
...
var CustomerAddressWrapper = exports.CustomerAddressWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  margin-top: 21px;\n  > div {\n    display: flex;\n    align-items: center;\n    svg {\n      color: ", ";\n      font-size: 14px;\n    }\n  \n    span {\n      flex: 1;\n      font-size: 14px;\n      line-height: 24px;\n      ", "\n    }\n  }\n\n  a {\n    ", "\n    font-size: 12px;\n  }\n"])), function (props) {
...
var SavedPlaces = exports.SavedPlaces = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 25px 20px;\n  overflow: auto;\n  ", "\n\n  > h2 {\n    font-size: 20px;\n    font-weight: 700;\n    margin-top: 0;\n    margin-bottom: 25px;\n\n    ", "\n  }\n\n  > p {\n    font-size: 16px;\n    line-height: 24px;\n    font-weight: 600;\n    margin-top: 0;\n    margin-bottom: 25px;\n  }  \n"])), function (_ref) {
  var openExtraAdddress = _ref.openExtraAdddress;
  return openExtraAdddress && (0, _styledComponents.css)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n    z-index: 10;\n  "])));
}, function (props) {
  var _props$theme7;
  return (_props$theme7 = props.theme) !== null && _props$theme7 !== void 0 && _props$theme7.rtl ? (0, _styledComponents.css)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n      margin-left: 40px;\n    "]))) : (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n      margin-right: 40px;\n    "])));
});
var AddressListWrapper = exports.AddressListWrapper = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  height: calc(100% - 120px);\n  > div:first-child {\n    position: relative;\n    display: flex;\n    box-sizing: border-box;\n    flex: 1;\n\n    > button{\n      width: auto;\n      align-self: center;\n      position: absolute;\n      bottom: 0px;\n\n      ", "\n    }\n\n    > ul {\n      margin-top: 0px;\n      max-height: calc(100% - 70px);\n      overflow: auto;\n    }\n  }\n\n\n  @media (min-width: 768px){\n    ul{\n      width: 100%;\n    }\n    >div {\n      > button {\n        width: 65%;\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme8;
  return (_props$theme8 = props.theme) !== null && _props$theme8 !== void 0 && _props$theme8.rtl ? (0, _styledComponents.css)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n        right: 0px;\n      "]))) : (0, _styledComponents.css)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n        left: 0px;\n      "])));
});