...
var SelectedUserWrapper = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  border-radius: 8px;\n  border: 1px solid ", ";\n  height: 44px;\n  display: flex;\n  align-items: center;\n  flex: 1;\n\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme4;
...
exports.SelectedUserWrapper = SelectedUserWrapper;
var CustomerAddressWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  margin-top: 21px;\n  > div {\n    display: flex;\n    align-items: center;\n    svg {\n      color: ", ";\n      font-size: 14px;\n    }\n  \n    span {\n      flex: 1;\n      font-size: 14px;\n      line-height: 24px;\n      ", "\n    }\n  }\n\n  a {\n    ", "\n    font-size: 12px;\n  }\n"])), function (props) {
...
exports.CustomerAddressWrapper = CustomerAddressWrapper;
var SavedPlaces = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 25px 20px;\n  overflow: auto;\n  ", "\n\n  > h2 {\n    font-size: 20px;\n    font-weight: 700;\n    margin-top: 0;\n    margin-bottom: 25px;\n\n    ", "\n  }\n\n  > p {\n    font-size: 16px;\n    line-height: 24px;\n    font-weight: 600;\n    margin-top: 0;\n    margin-bottom: 25px;\n  }  \n"])), function (_ref) {
...
var AddressListWrapper = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  height: calc(100% - 120px);\n  > div:first-child {\n    position: relative;\n    display: flex;\n    box-sizing: border-box;\n    flex: 1;\n\n    > button{\n      width: auto;\n      align-self: center;\n      position: absolute;\n      bottom: 0px;\n\n      ", "\n    }\n\n    > ul {\n      margin-top: 0px;\n      max-height: calc(100% - 70px);\n      overflow: auto;\n    }\n  }\n\n\n  @media (min-width: 768px){\n    ul{\n      width: 100%;\n    }\n    >div {\n      > button {\n        width: 65%;\n      }\n    }\n  }\n"])), function (props) {
  var _props$theme8;
...
exports.AddressListWrapper = AddressListWrapper;