...
var DriversLocation = function DriversLocation(props) {
  ...
  var mapFit = function mapFit() {
    var _assignedOrders$order, _assignedOrders$order2, _bounds$getNorthEast, _bounds$getNorthEast$, _bounds$getNorthEast2, _bounds$getNorthEast3, _bounds$getSouthWest, _bounds$getSouthWest$, _bounds$getSouthWest2, _bounds$getSouthWest3;
  ...
  }), selectedDriver && (assignedOrders === null || assignedOrders === void 0 ? void 0 : (_assignedOrders$order4 = assignedOrders.orders) === null || _assignedOrders$order4 === void 0 ? void 0 : _assignedOrders$order4.length) > 0 && assignedOrders.orders.map(function (order) {
  ...
  }), selectedDriver && (assignedOrders === null || assignedOrders === void 0 ? void 0 : (_assignedOrders$order5 = assignedOrders.orders) === null || _assignedOrders$order5 === void 0 ? void 0 : _assignedOrders$order5.length) > 0 && assignedOrders.orders.map(function (order) {
