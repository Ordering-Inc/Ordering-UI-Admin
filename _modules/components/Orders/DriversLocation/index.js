...
var DriversLocation = exports.DriversLocation = function DriversLocation(props) {
  var _configState$configs, _configState$configs2, _configState$configs3, _selectedOrder$custom3, _selectedOrder$custom4, _selectedOrder$custom5, _selectedOrder$custom6, _selectedOrder$custom7, _selectedOrder$busine3, _selectedOrder$busine4, _selectedOrder$busine5, _selectedOrder$driver3, _selectedOrder$driver4, _selectedOrder$driver5, _selectedOrder$driver6, _selectedOrder$driver7, _selectedOrder$driver8, _selectedOrder$driver9, _selectedOrder$driver0, _selectedOrder$driver1, _selectedOrder$driver10, _selectedOrder$driver11, _selectedOrder$driver12, _assignedOrders$order6, _assignedOrders$order7;
  ...
  var _useState9 = (0, _react.useState)(false),
    ...
    hasManualView = _useState0[0],
    setHasManualView = _useState0[1];
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, selectedDriver && (assignedOrders === null || assignedOrders === void 0 ? void 0 : assignedOrders.loading) && /*#__PURE__*/_react.default.createElement(_Shared.SpinnerLoader, {
    ...
    lng: (selectedOrder === null || selectedOrder === void 0 || (_selectedOrder$driver9 = selectedOrder.driver) === null || _selectedOrder$driver9 === void 0 ? void 0 : _selectedOrder$driver9.location) !== null && _typeof(selectedOrder === null || selectedOrder === void 0 || (_selectedOrder$driver0 = selectedOrder.driver) === null || _selectedOrder$driver0 === void 0 ? void 0 : _selectedOrder$driver0.location) === 'object' && selectedOrder !== null && selectedOrder !== void 0 && (_selectedOrder$driver1 = selectedOrder.driver) !== null && _selectedOrder$driver1 !== void 0 && (_selectedOrder$driver1 = _selectedOrder$driver1.location) !== null && _selectedOrder$driver1 !== void 0 && _selectedOrder$driver1.lng ? selectedOrder === null || selectedOrder === void 0 || (_selectedOrder$driver10 = selectedOrder.driver) === null || _selectedOrder$driver10 === void 0 ? void 0 : _selectedOrder$driver10.location.lng : typeof (selectedOrder === null || selectedOrder === void 0 || (_selectedOrder$driver11 = selectedOrder.driver) === null || _selectedOrder$driver11 === void 0 ? void 0 : _selectedOrder$driver11.location) === 'string' ? parseFloat(selectedOrder === null || selectedOrder === void 0 || (_selectedOrder$driver12 = selectedOrder.driver) === null || _selectedOrder$driver12 === void 0 || (_selectedOrder$driver12 = _selectedOrder$driver12.location) === null || _selectedOrder$driver12 === void 0 ? void 0 : _selectedOrder$driver12.split(',')[1].replace(/[^-.0-9]/g, '')) : defaultCenter.lng
