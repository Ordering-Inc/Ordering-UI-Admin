...
var GiftCardsTableWrapper = exports.GiftCardsTableWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  table {\n    width: 100%;\n    border-collapse: collapse;\n    td, th {\n      padding: 10px 0;\n      font-size: 14px;\n    }\n    thead {\n      border-bottom: 1px solid ", ";\n    }\n  }\n"])), function (props) {
  return props.theme.colors.disabled;
});
var GiftCardRow = exports.GiftCardRow = _styledComponents.default.tbody(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n"])), function (props) {
  return props.theme.colors.borderColor;
});
...
var PaginationWarpper = exports.PaginationWarpper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: flex-end;\n  margin: 20px 0;\n"])));