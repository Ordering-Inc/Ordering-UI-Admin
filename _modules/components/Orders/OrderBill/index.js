...
var OrderBill = exports.OrderBill = function OrderBill(props) {
  var _order$products, _order$metafields, _order$metafields$fin, _order$summary$subtot, _order$summary2, _ref, _order$summary3, _order$offers, _order$summary$discou, _order$summary4, _order$offers2, _order$offers3, _order$summary5, _order$summary6, _order$summary7, _ref2, _order$summary8, _order$summary$subtot2, _order$summary9, _order$taxes3, _order$summary$tax2, _order$summary0, _order$fees, _order$summary$servic, _order$summary1, _order$taxes4, _order$taxes5, _order$fees2, _order$fees3, _order$offers4, _order$offers5, _order$summary10, _order$summary11, _order$taxes6, _order$taxes7, _order$offers6, _order$offers7, _order$summary12, _order$summary13, _configs$driver_tip_t, _configs$driver_tip_u, _order$summary$driver, _order$summary14, _extraValueAdjustment, _order$summary$total, _order$summary15, _order$payment_events, _order$payment_events2, _order$payment_events3, _order$payment_events4, _order$delivery_optio, _order$delivery_optio2, _order$vehicle, _order$vehicle2, _order$vehicle3, _order$vehicle4, _order$vehicle5, _order$paymethod, _order$payment_events5;
  ...
  return /*#__PURE__*/_react.default.createElement(_styles2.OrderBillContainer, null, /*#__PURE__*/_react.default.createElement("table", null, /*#__PURE__*/_react.default.createElement("tbody", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, t('SUBTOTAL', 'Subtotal')), /*#__PURE__*/_react.default.createElement("td", null, parsePrice(((_order$summary$subtot = order === null || order === void 0 || (_order$summary2 = order.summary) === null || _order$summary2 === void 0 ? void 0 : _order$summary2.subtotal) !== null && _order$summary$subtot !== void 0 ? _order$summary$subtot : order === null || order === void 0 ? void 0 : order.subtotal) + getIncludedTaxes(), {
    ...
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  }))), (order === null || order === void 0 || (_order$taxes3 = order.taxes) === null || _order$taxes3 === void 0 ? void 0 : _order$taxes3.length) === 0 && (order === null || order === void 0 ? void 0 : order.tax_type) === 2 && /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, t('TAX', 'Tax'), /*#__PURE__*/_react.default.createElement("span", null, "(".concat((0, _utils.verifyDecimals)(order === null || order === void 0 ? void 0 : order.tax, parseNumber), "%)"))), /*#__PURE__*/_react.default.createElement("td", null, parsePrice((_order$summary$tax2 = order === null || order === void 0 || (_order$summary0 = order.summary) === null || _order$summary0 === void 0 ? void 0 : _order$summary0.tax) !== null && _order$summary$tax2 !== void 0 ? _order$summary$tax2 : 0, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  }))), (order === null || order === void 0 || (_order$fees = order.fees) === null || _order$fees === void 0 ? void 0 : _order$fees.length) === 0 && /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, t('SERVICE_FEE', 'Service fee'), /*#__PURE__*/_react.default.createElement("span", null, "(".concat((0, _utils.verifyDecimals)(order === null || order === void 0 ? void 0 : order.service_fee, parseNumber), "%)"))), /*#__PURE__*/_react.default.createElement("td", null, parsePrice((_order$summary$servic = order === null || order === void 0 || (_order$summary1 = order.summary) === null || _order$summary1 === void 0 ? void 0 : _order$summary1.service_fee) !== null && _order$summary$servic !== void 0 ? _order$summary$servic : 0, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  ...
  })), typeof (order === null || order === void 0 || (_order$summary10 = order.summary) === null || _order$summary10 === void 0 ? void 0 : _order$summary10.delivery_price) === 'number' && !isPickupOrder && /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, t('DELIVERY_FEE', 'Delivery Fee')), /*#__PURE__*/_react.default.createElement("td", null, parsePrice((order === null || order === void 0 || (_order$summary11 = order.summary) === null || _order$summary11 === void 0 ? void 0 : _order$summary11.delivery_price) + getIncludedTaxes(true), {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  ...
  })), ((order === null || order === void 0 || (_order$summary12 = order.summary) === null || _order$summary12 === void 0 ? void 0 : _order$summary12.driver_tip) > 0 || (order === null || order === void 0 ? void 0 : order.driver_tip) > 0) && /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, t('DRIVER_TIP', 'Driver tip'), ' ', ((order === null || order === void 0 || (_order$summary13 = order.summary) === null || _order$summary13 === void 0 ? void 0 : _order$summary13.driver_tip) > 0 || (order === null || order === void 0 ? void 0 : order.driver_tip) > 0) && parseInt(configs === null || configs === void 0 || (_configs$driver_tip_t = configs.driver_tip_type) === null || _configs$driver_tip_t === void 0 ? void 0 : _configs$driver_tip_t.value, 10) === 2 && !parseInt(configs === null || configs === void 0 || (_configs$driver_tip_u = configs.driver_tip_use_custom) === null || _configs$driver_tip_u === void 0 ? void 0 : _configs$driver_tip_u.value, 10) && /*#__PURE__*/_react.default.createElement("span", null, "(".concat((0, _utils.verifyDecimals)(order === null || order === void 0 ? void 0 : order.driver_tip, parseNumber), "%)"))), /*#__PURE__*/_react.default.createElement("td", null, parsePrice((_order$summary$driver = order === null || order === void 0 || (_order$summary14 = order.summary) === null || _order$summary14 === void 0 ? void 0 : _order$summary14.driver_tip) !== null && _order$summary$driver !== void 0 ? _order$summary$driver : order === null || order === void 0 ? void 0 : order.totalDriverTip, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
    ...
    className: "total"
  }, /*#__PURE__*/_react.default.createElement("tbody", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, t('TOTAL', 'Total')), /*#__PURE__*/_react.default.createElement("td", null, parsePrice((_order$summary$total = order === null || order === void 0 || (_order$summary15 = order.summary) === null || _order$summary15 === void 0 ? void 0 : _order$summary15.total) !== null && _order$summary$total !== void 0 ? _order$summary$total : order === null || order === void 0 ? void 0 : order.total, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
    ...
    colSpan: "2"
  }, t('DELIVERY_PREFERENCE', 'Delivery Preference')))), /*#__PURE__*/_react.default.createElement("tbody", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", null, order !== null && order !== void 0 && order.delivery_option ? t(order === null || order === void 0 || (_order$delivery_optio = order.delivery_option) === null || _order$delivery_optio === void 0 || (_order$delivery_optio = _order$delivery_optio.name) === null || _order$delivery_optio === void 0 || (_order$delivery_optio = _order$delivery_optio.toUpperCase()) === null || _order$delivery_optio === void 0 ? void 0 : _order$delivery_optio.replaceAll(' ', '_'), order === null || order === void 0 || (_order$delivery_optio2 = order.delivery_option) === null || _order$delivery_optio2 === void 0 ? void 0 : _order$delivery_optio2.name) : t('EITHER_WAY', 'Either way'))))), (order === null || order === void 0 ? void 0 : order.comment) && /*#__PURE__*/_react.default.createElement("table", {
    className: "comments"
