...
var RefundAmountWrapper = exports.RefundAmountWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  ", "\n"])), function (props) {
  var _props$theme3;
...
var RefundReasonContainer = exports.RefundReasonContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin: 40px 0;\n\n  label {\n    font-size: 14px;\n    margin-bottom: 7px;\n  }\n"])));
...
var SelectWrapper = exports.SelectWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 20px;\n  \n  > span {\n    font-size: 14px;\n    margin-bottom: 7px;\n  }\n  .select {\n    width: 100%;\n    background: ", ";\n    border: none;\n\n    > div:first-child {\n      padding-top: 4px;\n      padding-bottom: 4px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.secundary;
});
var ErrorText = exports.ErrorText = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  text-align: center;\n  color: ", ";\n  font-size: 16px;\n"])), function (props) {
