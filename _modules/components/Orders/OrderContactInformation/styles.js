...
var ActionIconWrapper = exports.ActionIconWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  height: 100%;\n  right: 0;\n  top: 0;\n  > .down-arrow {\n    transition: all 0.3s;\n    margin: 0 10px;\n  }\n  .edit-icon {\n    color: ", ";\n    cursor: pointer;\n  }\n"])), function (props) {
  return props.theme.colors.secundaryLight;
});
var ReviewWrapper = exports.ReviewWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  margin-top: 23px;\n  label {\n    font-size: 14px;\n    font-weight: 500;\n    margin-bottom: 12px;\n  }\n  textarea {\n    width: 100%;\n  }\n"])));
...
var CompanySelectorContainer = exports.CompanySelectorContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-top: 23px;\n  margin-bottom: 13px;\n  > p {\n    font-size: 14px;\n    margin-top: 0;\n    margin-bottom: 15px;\n  }\n  > div {\n    width: 100%;\n    border-radius: 8px;\n    background-color: ", ";\n\n    > div {\n      &:first-child {\n        border: none;\n        height: 50px;\n      }\n      > div:first-child {\n        color: ", ";\n      }\n    }\n  }\n"])), function (props) {
...
var DriverSelectorContainer = exports.DriverSelectorContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-top: 23px;\n  margin-bottom: 13px;\n  > p {\n    font-size: 14px;\n    margin-top: 0;\n    margin-bottom: 15px;\n  }\n  > div {\n    width: 100%;\n    border-radius: 8px;\n    background-color: ", ";\n\n    > div {\n      > div {\n        &:first-child {\n          border: none;\n          height: 50px;\n        }\n        > div:first-child {\n          color: ", ";\n        }\n      }\n    }\n  }\n"])), function (props) {
...
var CutsomerDetail = exports.CutsomerDetail = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n  padding-bottom: 15px;\n  margin-bottom: 15px;\n  width: 100%;\n"])), function (props) {
...
var CustomerInfoTable = exports.CustomerInfoTable = _styledComponents.default.table(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  width: 100%;\n\n  tr {\n    td {\n      color: ", ";\n      font-size: 12px;\n      margin: 0px;\n\n      &:first-child {\n        color: ", ";\n      }\n\n      > a {\n        color: ", ";\n        transition: all 0.3s linear;\n        &:hover {\n          color: ", ";\n        }\n      }\n    }\n  }\n"])), function (props) {
  ...
  return (_props$theme$colors0 = props.theme.colors) === null || _props$theme$colors0 === void 0 ? void 0 : _props$theme$colors0.primary;
}, function (props) {
  var _props$theme$colors1;
  return (_props$theme$colors1 = props.theme.colors) === null || _props$theme$colors1 === void 0 ? void 0 : _props$theme$colors1.headingColor;
});
var ToggleItemWrapper = exports.ToggleItemWrapper = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n\n  ", "\n"])), function (props) {
...
var ReviewButton = exports.ReviewButton = _styledComponents.default.span(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  color: ", ";\n  font-size: 14px;\n  text-decoration: underline;\n"])), function (props) {
  return props.theme.colors.primary;
});
var CustomerEditWrapper = exports.CustomerEditWrapper = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  input {\n    width: 100%;\n    margin-bottom: 12px;\n  }\n  .input-autocomplete {\n    width: 100%;\n    background: ", ";\n    border: 1px solid ", ";\n    border-radius: 8px;\n    font-size: 14px;\n    padding: 10px 15px;\n    outline: none;\n    ::placeholder {\n      color: ", ";\n    }\n\n    &:-ms-input-placeholder {\n      color: ", ";\n    }\n\n    &::-ms-input-placeholder { /* Microsoft Edge */\n      color: ", ";\n    }\n    &:focus {\n      border-color: ", ";\n    }\n  }\n  button {\n    margin-top: 10px;\n    display: block;\n    height: 44px;\n    border-radius: 8px;\n    margin-left: auto;\n  }\n"])), function (props) {
  var _props$theme$colors11;
  return ((_props$theme$colors11 = props.theme.colors) === null || _props$theme$colors11 === void 0 ? void 0 : _props$theme$colors11.backgroundPage) || '#FFF';
}, function (props) {
...
var WrapperMap = exports.WrapperMap = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 150px;\n  margin-bottom: 10px;\n\n  > div {\n    position: relative !important;\n    width: 100% !important;\n    height: 100% !important;\n    border-radius: 8px;\n  }\n\n  @media (min-width: 768px) {\n    height: 200px;\n  }\n"])));