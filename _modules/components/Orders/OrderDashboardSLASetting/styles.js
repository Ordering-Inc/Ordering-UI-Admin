...
var StatusItems = exports.StatusItems = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
var ItemStatus = exports.ItemStatus = _styledComponents.default.span(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 4px;\n  height: 22px;\n  margin: 0 15px;\n  border-radius: 4px;\n  background: ", ";\n"])), function (props) {
  return props.backColor;
});
var ItemHeader = exports.ItemHeader = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  margin-bottom: 5px;\n"])));
var ItemContent = exports.ItemContent = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  padding: 0 30px;\n\n  p {\n    font-weight: 400;\n    font-size: 12px;\n    line-height: 18px;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
var IconWrapper = exports.IconWrapper = _styledComponents.default.span(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: inline-flex;\n  width: fit-content;\n  height: fit-content;\n  background-color: #fff;\n  z-index: 2;\n"])));
var Actions = exports.Actions = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  padding-top: 22px;\n  button {\n    border-radius: 7.6px;\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    padding: 7px 15px;\n  }\n"])));
var TimerInputWrapper = exports.TimerInputWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  border: 1px solid ", ";\n  border-radius: 7.6px;\n  padding: 7px;\n  width: fit-content;\n  margin: 0 30px 15px;\n  color: ", ";\n\n  input {\n    flex: 1;\n    border: none !important;\n    outline: none !important;\n    padding: 5px;\n    font-size: 14px;\n    min-width: 38px;\n    width: fit-content;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
...
var OverLine = exports.OverLine = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  position: absolute;\n  height: 100%;\n  width: 15px;\n  top: 0;\n  background-color: #fff;\n"])));