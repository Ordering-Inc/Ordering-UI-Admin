...
exports.StatusBarContainer = exports.StatusBar = exports.SkeletonWrapper = exports.RejectReasonsContainer = exports.RejectReasonWrapper = exports.PlaceSpotContainer = exports.OrderStatusSelectorWrapper = exports.OrderStatus = exports.OrderProducts = exports.OrderDetailsExtraContent = exports.OrderDetailsContent = exports.Container = exports.CloseButtonWrapper = exports.ChatContainer = exports.ButtonLink = exports.AdvancedLogistic = void 0;
...
var RejectReasonWrapper = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  background-color: #FEEDF0;\n  padding: 4px 10px;\n  border-radius: 50px;\n  color: ", ";\n  font-size: 12px;\n  line-height: 18px;\n  margin: 15px 0;\n  width: fit-content;\n"])), function (props) {
