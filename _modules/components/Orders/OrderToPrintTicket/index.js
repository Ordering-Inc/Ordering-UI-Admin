...
var OrderToPrintTicket = exports.OrderToPrintTicket = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.PrintContainer, {
    ...
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  })) : /*#__PURE__*/_react.default.createElement(_styles.InsideInfo2, null, parsePrice((_order$summary$subtot2 = order === null || order === void 0 || (_order$summary0 = order.summary) === null || _order$summary0 === void 0 ? void 0 : _order$summary0.subtotal_with_discount) !== null && _order$summary$subtot2 !== void 0 ? _order$summary$subtot2 : 0, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  }))), (order === null || order === void 0 || (_order$taxes3 = order.taxes) === null || _order$taxes3 === void 0 ? void 0 : _order$taxes3.length) === 0 && (order === null || order === void 0 ? void 0 : order.tax_type) === 2 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_styles.InfoContainer, null, /*#__PURE__*/_react.default.createElement(_styles.InsideInfo, null, t('TAX', 'Tax'), ' ', "(".concat((0, _utils.verifyDecimals)(order === null || order === void 0 ? void 0 : order.tax, parseNumber), "%)")), /*#__PURE__*/_react.default.createElement(_styles.InsideInfo2, null, parsePrice((_order$summary$tax2 = order === null || order === void 0 || (_order$summary1 = order.summary) === null || _order$summary1 === void 0 ? void 0 : _order$summary1.tax) !== null && _order$summary$tax2 !== void 0 ? _order$summary$tax2 : 0, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  })))), (order === null || order === void 0 || (_order$fees = order.fees) === null || _order$fees === void 0 ? void 0 : _order$fees.length) === 0 && /*#__PURE__*/_react.default.createElement(_styles.InfoContainer, null, /*#__PURE__*/_react.default.createElement(_styles.InsideInfo, null, t('SERVICE_FEE', 'Service fee'), ' ', "(".concat((0, _utils.verifyDecimals)(order === null || order === void 0 ? void 0 : order.service_fee, parseNumber), "%)")), /*#__PURE__*/_react.default.createElement(_styles.InsideInfo2, null, parsePrice((_order$summary$servic = order === null || order === void 0 || (_order$summary10 = order.summary) === null || _order$summary10 === void 0 ? void 0 : _order$summary10.service_fee) !== null && _order$summary$servic !== void 0 ? _order$summary$servic : 0, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  ...
  })), /*#__PURE__*/_react.default.createElement(_styles.InfoContainer, null, /*#__PURE__*/_react.default.createElement(_styles.InsideInfo, null, t('DRIVER_TIP', 'Driver tip'), percentTip ? "(".concat(percentTip, "%)") : ''), /*#__PURE__*/_react.default.createElement(_styles.InsideInfo2, null, parsePrice((_order$summary$driver = order === null || order === void 0 || (_order$summary13 = order.summary) === null || _order$summary13 === void 0 ? void 0 : _order$summary13.driver_tip) !== null && _order$summary$driver !== void 0 ? _order$summary$driver : order === null || order === void 0 ? void 0 : order.totalDriverTip, {
    currency: (0, _utils.getCurrenySymbol)(order === null || order === void 0 ? void 0 : order.currency)
  }))), /*#__PURE__*/_react.default.createElement(_styles.InfoContainer, null, /*#__PURE__*/_react.default.createElement(_styles.InsideInfo, null, t('TOTAL', 'Total')), /*#__PURE__*/_react.default.createElement(_styles.InsideInfo2, null, parsePrice((_order$summary$total = order === null || order === void 0 || (_order$summary14 = order.summary) === null || _order$summary14 === void 0 ? void 0 : _order$summary14.total) !== null && _order$summary$total !== void 0 ? _order$summary$total : 0))));
});
