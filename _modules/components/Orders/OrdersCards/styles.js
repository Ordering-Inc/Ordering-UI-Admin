...
exports.WrapperPagination = exports.WrapperImage = exports.ViewDetails = exports.UnreadMessageCounter = exports.Timestatus = exports.Timer = exports.OrdersListContainer = exports.OrderNunberContainer = exports.OrderHeader = exports.OrderCard = exports.Image = exports.DriverSelectorWrapper = exports.CardHeading = exports.CardContent = exports.BusinessInfo = void 0;
...
var ImageStyled = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  border-radius: 10px;\n"])));
...
var CardContent = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  @media (min-width: 1300px) {\n    flex-direction: row;\n  }\n"])));

exports.CardContent = CardContent;

var DriverSelectorWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  width: 100%;\n  box-sizing: border-box;\n  margin-top: 10px;\n  > div {\n    > div {\n      border: none;\n      &:first-child {\n        .driver-photo {\n          width: 45px;\n          height: 45px;\n        }\n        .driver-info {\n          p {\n            color: ", ";\n            font-size: 14px;\n            font-weight: 600;\n          }\n          span {\n            display: initial;\n          }\n        }\n      }\n    }\n  }\n\n  @media (min-width: 1300px) {\n    width: 55%;\n    margin-top: 0px;\n    ", "\n  }\n"])), function (props) {
...
var WrapperPagination = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin: 10px 15px 0 15px;\n"])));

exports.WrapperPagination = WrapperPagination;

var UnreadMessageCounter = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 12px;\n  ", "\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: ", ";\n  border-radius: 8px;\n  font-size: 12px;\n  height: 24px;\n  color: ", ";\n  padding: 0 10px;\n"])), function (props) {
  var _props$theme4;
...
var Timestatus = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: 4px;\n  height: 130px;\n  border-radius: 20px;\n  left: 10px;\n  top: 17px;\n  ", "\n ", "\n  ", "\n  ", "\n"])), function (props) {
  var _props$theme5;
  ...
  return timeState === 'in_time' && (0, _styledComponents.css)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n    background-color: #00D27A;\n  "])));
}, function (_ref4) {
  var timeState = _ref4.timeState;
  return timeState === 'at_risk' && (0, _styledComponents.css)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n    background-color: #FFC700;\n  "])));
}, function (_ref5) {
  var timeState = _ref5.timeState;
  return timeState === 'delayed' && (0, _styledComponents.css)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    background-color: #E63757;\n  "])));
});
