...
var DashboardOrdersList = exports.DashboardOrdersList = function DashboardOrdersList(props) {
  ...
  var isFilteredOrder = function isFilteredOrder(order, lastHistoryData) {
    ...
    if ((filterValues === null || filterValues === void 0 || (_filterValues$driverG3 = filterValues.driverGroupBusinessIds) === null || _filterValues$driverG3 === void 0 ? void 0 : _filterValues$driverG3.length) > 0) {
    ...
    if ((filterValues === null || filterValues === void 0 || (_filterValues$groupTy = filterValues.groupTypesUnassigned) === null || _filterValues$groupTy === void 0 ? void 0 : _filterValues$groupTy.length) > 0) {
  ...
  */
  ...
  var _isDeepEmptyObject = function isDeepEmptyObject(obj) {
    for (var key in obj) {
      if (obj[key] !== null && _typeof(obj[key]) === 'object' && !_isDeepEmptyObject(obj[key])) {
        return false;
      }
  ...
  (0, _react.useEffect)(function () {
    ...
    if ((pagination === null || pagination === void 0 ? void 0 : pagination.currentPage) !== 0 && (pagination === null || pagination === void 0 ? void 0 : pagination.total) !== 0) {
      if (Math.ceil((pagination === null || pagination === void 0 ? void 0 : pagination.total) / pagination.pageSize) >= (pagination === null || pagination === void 0 ? void 0 : pagination.currentPage)) {
        if (orderList.orders.length === 0 && (filterValues && !_isDeepEmptyObject(filterValues) || !!searchValue)) {
