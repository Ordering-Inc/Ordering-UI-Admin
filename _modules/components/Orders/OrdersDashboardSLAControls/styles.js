...
var Timestatus = exports.Timestatus = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  width: 4px;\n  height: 22px;\n  border-radius: 20px 20px 20px 20px;\n  margin-right: 5px;\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (props) {
  ...
  return timeState === 'in_time' && (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n    background-color: #00D27A;\n  "])));
}, function (_ref3) {
  var timeState = _ref3.timeState;
  return timeState === 'at_risk' && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    background-color: #FFC700;\n  "])));
}, function (_ref4) {
  var timeState = _ref4.timeState;
  return timeState === 'delayed' && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    background-color: #E63757;\n  "])));
});