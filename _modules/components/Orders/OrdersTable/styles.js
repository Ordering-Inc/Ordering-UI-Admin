...
var OrderNumberContainer = exports.OrderNumberContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  p {\n    max-width: 180px;\n  }\n\n  ", "\n"])), function (props) {
  var _props$theme2;
  return (_props$theme2 = props.theme) !== null && _props$theme2 !== void 0 && _props$theme2.rtl ? (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n    border-left: 1px solid #E9ECEF;\n    padding-left: 15px;\n  "]))) : (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    border-right: 1px solid #E9ECEF;\n    padding-right: 15px;\n  "])));
});
var CheckBox = exports.CheckBox = _styledComponents.default.span(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  ", "\n  svg {\n    font-size: 24px;\n    color: #B1BCCC;\n\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
  ...
  return isChecked && (0, _styledComponents.css)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n      color: ", ";\n    "])), function (props) {
...
var CustomerInfo = exports.CustomerInfo = (0, _styledComponents.default)(BusinessInfo)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  p {\n    max-width: 125px;\n  }\n"])));
var StatusInfo = exports.StatusInfo = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  .bold {\n    max-width: 150px;\n    font-weight: 600;\n    margin: 0;\n  }\n"])));
var ChannelInfo = exports.ChannelInfo = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  .bold {\n    max-width: 150px;\n    font-weight: 600;\n    margin: 0;\n  }\n"])));
var EtaInfo = exports.EtaInfo = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  .bold {\n    max-width: 150px;\n    font-weight: 600;\n    margin: 0;\n  }\n"])));
var PodInfo = exports.PodInfo = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  .bold {\n    max-width: 150px;\n    font-weight: 600;\n    margin: 0;\n  }\n"])));
var DriversInfo = exports.DriversInfo = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  .select {\n    > div:first-child {\n      padding-left: 0;\n      padding-right: 0;\n    }\n  }\n  > div {\n    > div {\n      border: none;\n      &:first-child {\n        .driver-photo {\n          width: 45px;\n          height: 45px;\n        }\n        .driver-info {\n          p {\n            color: ", ";\n            font-size: 14px;\n            font-weight: 600;\n          }\n          span {\n            display: initial;\n          }\n        }\n      }\n    }\n  }\n  ", "\n"])), function (props) {
  ...
  return noClick && (0, _styledComponents.css)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});
...
var OrderType = exports.OrderType = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  img, svg {\n    width: 25px;\n    height: 30px;\n  }\n\n  img {\n    border-radius: unset;\n    border: none;\n  }\n\n  span {\n    color: ", ";\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
...
var WrapOrderStatusSelector = exports.WrapOrderStatusSelector = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  > div {\n    p {\n      font-size: 14px;\n    }\n    > div:first-child {\n      p {\n        color: ", ";\n        max-width: 140px;\n      }\n    }\n  }\n"])), function (props) {
...
var WrapperPagination = exports.WrapperPagination = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  padding-top: 5px;\n"])));
var LogisticStatusDot = exports.LogisticStatusDot = _styledComponents.default.span(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  width: 6px;\n  height: 6px;\n  border-radius: 50%;\n  display: inline-block;\n\n  ", "\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (props) {
  var _props$theme6;
  ...
  return status === 0 && (0, _styledComponents.css)(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.orange;
  });
}, function (_ref8) {
  var status = _ref8.status;
  return status === 1 && (0, _styledComponents.css)(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.warning;
  });
}, function (_ref9) {
  var status = _ref9.status;
  return status === 2 && (0, _styledComponents.css)(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.info;
  });
}, function (_ref0) {
  var status = _ref0.status;
  return status === 3 && (0, _styledComponents.css)(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.danger;
  });
}, function (_ref1) {
  var status = _ref1.status;
  return status === 4 && (0, _styledComponents.css)(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.success;
  });
});
var PriorityDot = exports.PriorityDot = _styledComponents.default.span(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  width: 6px;\n  height: 6px;\n  border-radius: 50%;\n  display: inline-block;\n\n  ", "\n\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (props) {
  var _props$theme7;
  return (_props$theme7 = props.theme) !== null && _props$theme7 !== void 0 && _props$theme7.rtl ? (0, _styledComponents.css)(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n    margin-right: 6px;\n  "]))) : (0, _styledComponents.css)(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n    margin-left: 6px;\n  "])));
}, function (_ref10) {
  var priority = _ref10.priority;
  return priority === -1 && (0, _styledComponents.css)(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.secundaryLight;
  });
}, function (_ref11) {
  var priority = _ref11.priority;
  return priority === 0 && (0, _styledComponents.css)(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.primary;
  });
}, function (_ref12) {
  ...
  return priority === 2 && (0, _styledComponents.css)(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["\n    background-color: ", ";\n  "])), function (props) {
    return props.theme.colors.danger;
  });
});
var Timestatus = exports.Timestatus = _styledComponents.default.div(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["\n  width: 4px;\n  height: 37px;\n  border-radius: 20px 20px 20px 20px;\n  ", "\n  ", "\n  ", "\n"])), function (_ref14) {
  var timeState = _ref14.timeState;
  return timeState === 'in_time' && (0, _styledComponents.css)(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["\n    background-color: #00D27A;\n  "])));
}, function (_ref15) {
  var timeState = _ref15.timeState;
...
var Timer = exports.Timer = _styledComponents.default.div(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["\n  min-width: 65px;\n  p {\n    margin: 0px;\n    color: ", ";\n    font-size: 12px;\n  }\n\n  .bold {\n    font-size: 14px;\n    font-weight: 600;\n    color: ", ";\n  }\n\n  .in_time{\n    color: #00D27A;\n  }\n\n  .at_risk {\n    color: #FFC700;\n  }\n\n  .delayed {\n    color: #E63757;\n  }\n"])), function (props) {
...
var OrdersCountWrapper = exports.OrdersCountWrapper = _styledComponents.default.div(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["\n  height: 16px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 50px;\n  background-color: ", ";\n  color: ", ";\n  font-weight: 400;\n  font-size: 9px;\n  line-height: 12px;\n  padding: 2px 5px;\n  position: absolute;\n  top: -9px;\n  right: -5px;\n  ", "\n\n  ", "\n"])), function (props) {
  ...
  var isNew = _ref17.isNew;
  return isNew && (0, _styledComponents.css)(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["\n    background-color: ", ";\n    color: ", ";\n  "])), function (props) {
    return props.theme.colors.lightGreen;
  }, function (props) {
    return props.theme.colors.success;
  });
});
var DragTh = exports.DragTh = _styledComponents.default.th(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  ", "\n"])), function (_ref18) {
  var selectedDragOver = _ref18.selectedDragOver;
  return selectedDragOver && (0, _styledComponents.css)(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["\n    border: 1px solid ", ";\n  "])), function (props) {
    return props.theme.colors.primary;
  });
});
var InfoWrapper = exports.InfoWrapper = _styledComponents.default.div(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["\n  position: relative;\n  ", "\n\n  .bold {\n    max-width: 150px;\n    font-weight: 600;\n    margin: 0;\n  }\n\n  &:hover > div {\n    visibility: visible;\n    opacity: 1;\n  }\n"])), function (props) {
  var _props$theme8;
  return (_props$theme8 = props.theme) !== null && _props$theme8 !== void 0 && _props$theme8.rtl ? (0, _styledComponents.css)(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["\n    margin-left: 4px;\n  "]))) : (0, _styledComponents.css)(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n    margin-right: 4px;\n  "])));
});