...
var AccordionText = exports.AccordionText = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  font-weight: 400;\n  font-size: 14px;\n  padding: 18px;\n"])));
var ProductComment = exports.ProductComment = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  padding-left: 40px;\n  ", "\n  p {\n    font-weight: bold;\n    margin: 0px;\n  }\n\n  h3 {\n    font-size: 14px;\n    font-weight: normal;\n    text-transform: capitalize;\n    margin: 0px 20px 0px 40px;\n    display: -webkit-box;\n    line-height: 1.5;\n    ", "\n  }\n"])), function (props) {
  var _props$theme4;
...
var ProductError = exports.ProductError = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n\n  span {\n    font-size: 18px;\n    text-align: center;\n  }\n\n  @media (min-width: 411px){\n    width: 35%;\n\n    span{\n      text-align: right;\n    }\n  }\n"])));
var ProductActions = exports.ProductActions = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: flex-end;\n"])));
var ProductActionsEdit = exports.ProductActionsEdit = _styledComponents.default.span(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  svg {\n    font-size: 20px;\n    margin-right: 5px;\n    cursor: pointer;\n    ", "\n  }\n"])), function (props) {
  var _props$theme6;
...
var ProductActionsDelete = exports.ProductActionsDelete = (0, _styledComponents.default)(ProductActionsEdit)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: none;\n  svg {\n    margin-right: 0px;\n  }\n\n  @media (min-width: 411px){\n    display: block;\n  }\n"])));
var ProductPriceSection = exports.ProductPriceSection = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n"])));
var ProductPrice = exports.ProductPrice = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  width: 100%;\n  display: flex;\n  justify-content: flex-end;\n\n  p,\n  span {\n    font-size: 14px;\n    color: ", ";\n  }\n\n  span {\n    font-weight: 500;\n  }\n\n  p {\n    margin: 0px 5px;\n  }\n\n  svg {\n    cursor: pointer;\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
});
var ProductSelect = exports.ProductSelect = _styledComponents.default.select(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  max-width: 55px;\n  height: 50px;\n  border: 0;\n  background-color: transparent;\n  font-size: 17px;\n  outline: none;\n  margin-left: 5px;\n\n  ", "\n"])), function (props) {
  var _props$theme7;
...
var ProductNotAvailable = exports.ProductNotAvailable = _styledComponents.default.span(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  color: #D81212;\n"])));
var ProductOptionsList = exports.ProductOptionsList = _styledComponents.default.ul(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  list-style-type: none;\n\n  .suboption {\n    margin-left: -25px;\n    ", "\n  }\n\n  p:nth-child(1) {\n    margin-bottom: 0;\n  }\n\n  p {\n    font-weight: 400;\n    margin: 0px;\n    color: ", ";\n    font-size: 12px;\n  }\n\n  li span {\n    color: ", ";\n    font-size: 12px;\n  }\n\n  li.ingredient {\n    padding-left: 15px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme8;
...
var ProductQuantity = exports.ProductQuantity = _styledComponents.default.span(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  p {\n    margin: 0px 5px;\n  }\n  margin: 0 10px 0 20px;\n\n  ", "\n"])), function (props) {
  var _props$theme0;
  return ((_props$theme0 = props.theme) === null || _props$theme0 === void 0 ? void 0 : _props$theme0.rtl) && (0, _styledComponents.css)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n    margin: 0 20px 0 10px;\n  "])));
});
var ScheduleInfoWrapper = exports.ScheduleInfoWrapper = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  width: calc(100% - 65px);\n  box-sizing: border-box;\n  h3 {\n    margin: 0px;\n    font-size: 14px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    color: ", ";\n  }\n  padding-left: 10px;\n  ", "\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n    padding-left: 0px;\n    padding-right: 10px;\n  "])));
});
var ScheduleInfo = exports.ScheduleInfo = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  span {\n    font-weight: 400;\n    font-size: 12px;\n    line-height: 15px;\n  }\n"])));