...
var WebsocketStatusDot = exports.WebsocketStatusDot = _styledComponents.default.span(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  display: inline-block;\n\n  ", "\n  ", "\n  ", "\n"])), function (_ref) {
  ...
  return status === 2 && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    background-color: #E63757;\n  "])));
});
var DateWrapper = exports.DateWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  text-align: center;\n"])));
...
var DetailContainer = exports.DetailContainer = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  h2 {\n    font-weight: 700;\n    font-size: 20px;\n    line-height: 30px;\n  }\n\n  > p {\n    font-size: 14px;\n  }\n"])));
var StatusItemWrapper = exports.StatusItemWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  > div {\n    display: flex;\n    align-items: center;\n\n    > span:first-child {\n      margin: 0 16px;\n    }\n  }\n  p {\n    font-weight: 400;\n    font-size: 12px;\n    line-height: 18px;\n    color: ", ";\n\n    ", "\n  }\n"])), function (props) {
...
var ButtonsContainer = exports.ButtonsContainer = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 40px;\n\n  > button {\n    border-radius: 8px;\n    height: 40px;\n    &:last-child {\n      margin: 0 10px;\n    }\n  }\n"])));