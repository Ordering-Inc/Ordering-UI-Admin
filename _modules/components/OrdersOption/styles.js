...
var OrdersContainer = _styledComponents.default.div(_templateObject2(), function (_ref4) {
  var activeOrders = _ref4.activeOrders;
  return activeOrders && (0, _styledComponents.css)(_templateObject3(), function (_ref5) {
  ...
  return !activeOrders && (0, _styledComponents.css)(_templateObject12());
});

exports.OrdersContainer = OrdersContainer;

var SkeletonOrder = _styledComponents.default.div(_templateObject13(), function (_ref12) {
  var activeOrders = _ref12.activeOrders;
  return activeOrders && (0, _styledComponents.css)(_templateObject14(), function (props) {
    var _props$theme5;

    return ((_props$theme5 = props.theme) === null || _props$theme5 === void 0 ? void 0 : _props$theme5.rtl) && (0, _styledComponents.css)(_templateObject15());
  });
}, function (_ref13) {
  var activeOrders = _ref13.activeOrders;
  return !activeOrders && (0, _styledComponents.css)(_templateObject16());
});

exports.SkeletonOrder = SkeletonOrder;

var SkeletonCard = _styledComponents.default.div(_templateObject17());

exports.SkeletonCard = SkeletonCard;

var SkeletonMap = _styledComponents.default.div(_templateObject18());

exports.SkeletonMap = SkeletonMap;

var SkeletonContent = _styledComponents.default.div(_templateObject19(), function (_ref14) {
  ...
  return !activeOrders && (0, _styledComponents.css)(_templateObject21());
});

exports.SkeletonContent = SkeletonContent;

var SkeletonText = _styledComponents.default.div(_templateObject22(), function (props) {
  var _props$theme6;
...
var SkeletonButton = _styledComponents.default.div(_templateObject24());

exports.SkeletonButton = SkeletonButton;

var SkeletonInformation = _styledComponents.default.div(_templateObject25());

exports.SkeletonInformation = SkeletonInformation;

var SkeletonReorder = _styledComponents.default.div(_templateObject26(), function (props) {
  var _props$theme7;

  return ((_props$theme7 = props.theme) === null || _props$theme7 === void 0 ? void 0 : _props$theme7.rtl) && (0, _styledComponents.css)(_templateObject27());
}, function (props) {
  var _props$theme8;

  return ((_props$theme8 = props.theme) === null || _props$theme8 === void 0 ? void 0 : _props$theme8.rtl) ? (0, _styledComponents.css)(_templateObject28()) : (0, _styledComponents.css)(_templateObject29());
});

exports.SkeletonReorder = SkeletonReorder;

var ImageNotFound = _styledComponents.default.div(_templateObject30());

exports.ImageNotFound = ImageNotFound;

var BusinessInformation = _styledComponents.default.div(_templateObject31(), function (_ref16) {
  var activeOrders = _ref16.activeOrders;
  return activeOrders && (0, _styledComponents.css)(_templateObject32());
}, function (props) {
  var _props$theme9;

  return ((_props$theme9 = props.theme) === null || _props$theme9 === void 0 ? void 0 : _props$theme9.rtl) && (0, _styledComponents.css)(_templateObject33());
}, function (_ref17) {
  ...
  return activeOrders && (0, _styledComponents.css)(_templateObject35());
});
