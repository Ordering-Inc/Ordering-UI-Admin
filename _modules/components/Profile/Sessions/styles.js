...
var ButtonGroupWrapper = exports.ButtonGroupWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n"])));
var ButtonsGroup = exports.ButtonsGroup = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  max-width: 600px;\n\n  > button {\n    height: 44px;\n    margin: 10px 0;\n    border-radius: 8px;\n  }\n\n  @media (min-width: 768px) {\n    flex-direction: row;\n    align-items: center;\n    justify-content: space-around;\n  }\n"])));