...
exports.LegendContent = exports.LegendItem = exports.CustomerLegend = exports.EmptyContent = exports.TableWrapper = exports.Tfoot = exports.Tbody = exports.Thead = exports.DistanceTable = exports.DistanceTitleBlock = exports.DistancePerBrandWrapper = exports.BrandBusinessWrapper = exports.CalendarWrapper = exports.ButtonActionList = exports.Title = exports.ReportsDistanceContainer = void 0;
...
var ReportsDistanceContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  padding: 35px 15px;\n  width: 100%;\n\n  @media (min-width: 700px) {\n    padding: 35px;\n  }\n"])));

exports.ReportsDistanceContainer = ReportsDistanceContainer;
...
var CustomerLegend = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n"])));

exports.CustomerLegend = CustomerLegend;

var LegendItem = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  margin-right: 20px;\n\n  ", "\n\n  p {\n    font-weight: 500;\n    font-size: 17px;\n    margin: 0;\n  }\n"])), function (props) {
  var _props$theme11;

  return ((_props$theme11 = props.theme) === null || _props$theme11 === void 0 ? void 0 : _props$theme11.rtl) && (0, _styledComponents.css)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n    margin-right: 0;\n    margin-left: 20px;\n  "])));
});

exports.LegendItem = LegendItem;

var LegendContent = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  > div {\n    width: 12px;\n    height: 12px;\n    min-width: 12px;\n    min-height: 12px;\n    border-radius: 1px;\n    margin-right: 3px;\n    background: red;\n\n    ", "\n  }\n\n  > span {\n    font-size: 12px;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n      margin-right: 0;\n      margin-left: 3px;\n    "])));
}, function (props) {
  var _props$theme12;

  return (_props$theme12 = props.theme) === null || _props$theme12 === void 0 ? void 0 : _props$theme12.colors.lightGray;
});
