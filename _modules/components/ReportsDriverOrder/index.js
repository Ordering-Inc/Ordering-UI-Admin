...
var ReportsDriverOrderUI = function ReportsDriverOrderUI(props) {
  ...
  var downloadTable = function downloadTable() {
    ...
    htmlToImage.toPng(tableRef === null || tableRef === void 0 ? void 0 : tableRef.current).then(function (dataUrl) {
      ...
      a.href = dataUrl;
      a.download = "".concat(t('NUMBER_ORDERS_SPECIFIC_RANGE', 'Number of orders within a specific range'), ".png"); // Trigger the download
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.ReportsBusinessSpendContainer, null, /*#__PURE__*/_react.default.createElement(_styles.Title, null, t('NUMBER_ORDERS_SPECIFIC_RANGE', 'Number of orders within a specific range')), /*#__PURE__*/_react.default.createElement(_styles.ButtonActionList, null, /*#__PURE__*/_react.default.createElement(_styles.BrandBusinessWrapper, null, /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
