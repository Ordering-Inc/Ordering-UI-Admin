...
var ReportsOrderDistanceUI = function ReportsOrderDistanceUI(props) {
  ...
  var downloadTable = function downloadTable() {
    ...
    htmlToImage.toPng(tableRef === null || tableRef === void 0 ? void 0 : tableRef.current).then(function (dataUrl) {
      ...
      a.href = dataUrl;
      a.download = "".concat(t('ORDERS_DELIVERY', 'Orders delivery'), ".png"); // Trigger the download
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.ReportsDistanceContainer, null, /*#__PURE__*/_react.default.createElement(_styles.Title, null, t('DISTANCE_STORE_CUSTOMER', 'Distance in KM from the store to customer')), /*#__PURE__*/_react.default.createElement(_styles.ButtonActionList, null, /*#__PURE__*/_react.default.createElement(_styles.BrandBusinessWrapper, null, /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
  ...
  }))) : /*#__PURE__*/_react.default.createElement(_styles.EmptyContent, null, t('NO_DATA', 'No Data')))), /*#__PURE__*/_react.default.createElement(_styles.DistancePerBrandWrapper, null, /*#__PURE__*/_react.default.createElement(_ReportsBarChart.ReportsBarChart, {
