...
var ReviewCustomerUI = function ReviewCustomerUI(props) {
  var customer = props.customer,
      ...
      handleChangeQualification = props.handleChangeQualification,
  ...
  }, t('SEND_REVIEW', 'Send review'))), /*#__PURE__*/_react.default.createElement(_Confirm.Alert, {
...
var ReviewCustomer = function ReviewCustomer(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_orderingComponentsAdmin.ReviewCustomer, reviewProps);
};
