...
var CountryName = exports.CountryName = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  flex: 1;\n  font-size: 12px;\n  display: flex;\n  align-items: center;\n"])));
var ActionsContainer = exports.ActionsContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  min-width: 30%;\n  font-size: 12px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding-top: 8px;\n  padding-bottom: 8px;\n  box-sizing: border-box;\n\n  ", "\n\n  ", "\n"])), function (props) {
  ...
  return !isHeader && (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n    ", "\n  "])), function (props) {
