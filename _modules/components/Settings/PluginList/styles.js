...
var PluginListContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 20px;\n  box-sizing: border-box;\n"])));

exports.PluginListContainer = PluginListContainer;

var PLuginsSeparator = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  width: 100%;\n  max-height: ", ";\n  box-sizing: border-box;\n  overflow-y: auto;\n"])), function (props) {
  var _props$h;

  return (_props$h = props.h) !== null && _props$h !== void 0 ? _props$h : '100%';
});

exports.PLuginsSeparator = PLuginsSeparator;
...
var PluginsTable = _styledComponents.default.table(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  width: 100%;\n  margin-top: 25px;\n\n  thead {\n    border-bottom: 1px solid ", ";\n    th {\n      padding: 10px 0;\n      font-size: 12px;\n    }\n  }\n\n  tr {\n    display: flex;\n    align-items: center;\n    th, td {\n      &:first-child {\n        flex: 1;\n        > input {\n          outline: none;\n          border: 1px dashed ", ";\n          padding: 3px;\n          width: 96%;\n        }\n      }\n    }\n\n    th:last-child {\n      min-width: 130px;\n      ", "\n    }\n  }\n"])), function (props) {
  return props.theme.colors.secundaryLight;
}, function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  return props.theme.colors.rtl ? (0, _styledComponents.css)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n        padding-right: 15px;\n      "]))) : (0, _styledComponents.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n        padding-left: 15px;\n      "])));
});

exports.PluginsTable = PluginsTable;

var PluginTbody = _styledComponents.default.tbody(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid ", ";\n\n  td {\n    padding: 7px 0;\n    font-size: 12px;\n  }\n\n  ", "\n\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref) {
  var isAddMode = _ref.isAddMode;
  return !isAddMode && (0, _styledComponents.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n    &:hover {\n      background-color: ", ";\n    }\n  "])), function (props) {
...
exports.PluginTbody = PluginTbody;

var ActionsContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding-top: 8px;\n  padding-bottom: 8px;\n\n  ", "\n"])), function (props) {
