...
var SettingsUI = function SettingsUI(props) {
  ...
  var handleOpenCheckout = function handleOpenCheckout(isInitialRender) {
    ...
    if (!isInitialRender) {
      history.replace("".concat(location.pathname, "?category=site"));
    }
  };
