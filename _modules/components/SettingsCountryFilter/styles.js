...
exports.CountryListItem = exports.CountryListContainer = exports.CountrySearchInput = exports.SearchIconWrapper = exports.CountrySearchWrapper = exports.CountrySelectWrapper = void 0;
...
var CountryListItem = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  padding: 10px 7px;\n  border-bottom: 1px solid ", ";\n  font-size: 13px;\n  color: ", ";\n  cursor: pointer;\n  transition: all 0.3s;\n  &:hover {\n    background: ", ";\n  }\n\n  ", "\n"])), function (props) {
  ...
  return (_props$theme8 = props.theme) === null || _props$theme8 === void 0 ? void 0 : _props$theme8.colors.borderColor;
}, function (_ref) {
