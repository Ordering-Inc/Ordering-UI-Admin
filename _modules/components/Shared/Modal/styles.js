...
var ModalDialogInnerContainer = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  position: relative;\n  padding: ", ";\n  overflow: ", ";\n  background-color: ", ";\n  width: 100%;\n  height: 100%;\n"])), function (_ref4) {
...
exports.ModalDialogInnerContainer = ModalDialogInnerContainer;
var ModalActions = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-around;\n  margin: 30px 0px 0px;\n\n  button {\n    width: 100%;\n    border-radius: 32px;\n    opacity: 1;\n    max-width: 300px;\n    margin-top: 10px;\n    height: 60px;\n  }\n"])));
