...
var BusinessName = exports.BusinessName = _styledComponents.default.span(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var NoSelectedBrand = exports.NoSelectedBrand = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  padding: 30px 10px;\n  font-size: 18px;\n  text-align: center;\n"])));
var SelectButtonGroup = exports.SelectButtonGroup = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 20px;\n  padding-bottom: 13px;\n  border-bottom: 1px solid ", ";\n  button:first-child {\n    ", "\n  }\n"])), function (props) {
