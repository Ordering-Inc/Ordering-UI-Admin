...
var ZoneTbody = _styledComponents.default.tbody(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  border-bottom: 1px solid ", ";\n  tr {\n    td {\n      font-size: 14px;\n      padding: 13px 0;\n      &.arrow {\n        font-size: 13px;\n        color: ", ";\n      }\n    }\n  }\n  &:hover {\n    background-color: ", ";\n  }\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
...
var ActionsWrapper = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));
exports.ActionsWrapper = ActionsWrapper;
var AddDeliveryZoneButtonWrapper = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  padding: 10px 0;\n"])));
exports.AddDeliveryZoneButtonWrapper = AddDeliveryZoneButtonWrapper;
