...
var BrandListTable = exports.BrandListTable = _styledComponents.default.table(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  width: 100%;\n  min-width: 500px;\n\n  thead {\n    border-bottom: 1px solid ", ";\n    th {\n      padding: 10px 0;\n      font-size: 12px;\n    }\n  }\n\n  tr {\n    th, td {\n      &:last-child {\n        width: 100px;\n        min-width: 100px;\n      }\n      &:not(:last-child) {\n        flex: 1;\n      }\n    }\n  }\n\n  th:last-child {\n    ", "\n  }\n"])), function (props) {
  ...
  return props.theme.colors.rtl ? (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n      padding-right: 15px;\n    "]))) : (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n      padding-left: 15px;\n    "])));
});
var BrandBody = exports.BrandBody = _styledComponents.default.tbody(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  border-bottom: 1px solid ", ";\n\n  td {\n    padding: 7px 0;\n    font-size: 12px;\n    input {\n      border: none;\n      width: 100%;\n      padding: 3px 0;\n      outline: none;\n      &:focus {\n        border: 1px solid ", ";\n      }      \n    }\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", "\n"])), function (props) {
...
var BrandGeneralInfo = exports.BrandGeneralInfo = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));
...
var BrandListTableWrapper = exports.BrandListTableWrapper = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  overflow: auto;\n  margin-top: 20px;\n  width: 100%;\n"])));
var BrandListBottomContainer = exports.BrandListBottomContainer = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 16px;\n"])));