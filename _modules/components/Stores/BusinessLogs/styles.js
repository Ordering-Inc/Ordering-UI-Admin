...
var UserInfoContainer = exports.UserInfoContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  p {\n    color: ", ";\n    margin: 0px;\n    font-size: 12px;\n    &:first-child {\n      color: ", ";\n      font-weight: 500;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
  return props.theme.colors.headingColor;
});
var DateTimeWrapper = exports.DateTimeWrapper = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  white-space: nowrap;\n  font-size: 12px;\n  min-height: 36px;\n  display: flex;\n  align-items: center;\n\n  ", "\n"])), function (props) {
  var _props$theme5;
...
var NoData = exports.NoData = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  font-size: 16px;\n"])));
var WrapperPagination = exports.WrapperPagination = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 20px 0;\n"])));
var DataListTable = exports.DataListTable = _styledComponents.default.table(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  width: 100%;\n  border-right: 1px solid ", ";\n\n  tbody {\n    border-bottom: none;\n    td {\n      box-sizing: border-box;\n      &:first-child {\n        width: 50% !important;\n        padding-left: 15px;\n        padding-right: 15px;\n        box-sizing: border-box;\n      }\n      &:not(:first-child) {\n        width: initial !important;\n      }\n      white-space: nowrap;\n      padding-top: 10px;\n      padding-bottom: 10px;\n      ", "\n    }\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme6;
...
var EventTypeContainer = exports.EventTypeContainer = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  white-space: nowrap;\n  font-size: 12px;\n  min-height: 36px;\n  display: flex;\n  align-items: center;\n  padding-right: 15px;\n  padding-left: 15px;\n  margin-left: 15px;\n  margin-right: 10px;\n  border-right: 1px solid ", ";\n  border-left: 1px solid ", ";\n  p{\n    margin-bottom: 0px;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  return props.theme.colors.borderColor;
});
var SchedulesWrapper = exports.SchedulesWrapper = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: row;\n  gap: 30px;\n  justify-content: center;\n\n  ", "\n"])), function (props) {
  return (props === null || props === void 0 ? void 0 : props.border) && (0, _styledComponents.css)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n    div:first-child {\n    border-right: 1px solid #E9ECEF;\n    padding-right: 30px;\n    "])));
});
var Schedules = exports.Schedules = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n"])));
var ScheduleDay = exports.ScheduleDay = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  justify-content: space-between;\n"])));
var ScheduleLapses = exports.ScheduleLapses = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  border-left: 1px solid #E9ECEF;\n  padding-left: 10px;\n\n  p  {\n    margin: 0px;\n  }\n"])));
var ScheduleTitle = exports.ScheduleTitle = _styledComponents.default.h2(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));