...
var ActionBlock = exports.ActionBlock = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  background: ", ";\n  position: absolute;\n  z-index: 1000;\n  display: flex;\n  align-items: center;\n  > button {\n    display: none;\n  }\n\n  ", "\n\n  @media (min-width: 1000px) {\n    > button {\n      display: block;\n      ", "\n    }\n  }\n"])), function (props) {
  ...
  var _props$theme4;
  return (_props$theme4 = props.theme) !== null && _props$theme4 !== void 0 && _props$theme4.rtl ? (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n        margin-right: 10px;\n      "]))) : (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n        margin-left: 10px;\n      "])));
});
...
var TabContainer = exports.TabContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  border-bottom: 1px solid #CCC;\n  overflow-x: auto;\n  @media (min-width: 1025px) {\n    overflow-x: hidden;\n  }\n"])));
var TabInnerContainer = exports.TabInnerContainer = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
var Tab = exports.Tab = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  padding: 10px 0px;\n  cursor: pointer;\n  color: ", ";\n  white-space: nowrap;\n  font-size: 14px;\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n"])), function (props) {
  ...
  return disabledFeature && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    background-color: ", ";\n    border-radius: 5px;\n    cursor: not-allowed;\n  "])), function (props) {
    return props.theme.colors.disabled;
  });
});
var BusinessMenuBasicContainer = exports.BusinessMenuBasicContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n"])));
var BusinessScheduleWrapper = exports.BusinessScheduleWrapper = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  > div {\n    padding: 0px;\n\n    h1 {\n      font-size: 18px;\n      margin-top: 30px;\n    }\n\n    > div {\n      margin-top: 0px;\n    }\n  }\n"])));