...
exports.BusinessPlaceListUI = exports.BusinessPlaceList = void 0;
...
var BusinessPlaceListUI = function BusinessPlaceListUI(props) {
  var _placeList$places, _placeList$places2;

  var placeList = props.placeList,
  ...
  var handleOpenDetail = function handleOpenDetail(place) {
    setOpenDetail(true);
  ...
  var handleUpdateSelectedPlace = function handleUpdateSelectedPlace(place) {
    setSelectedPlace(place);
  };
  ...
  var handleCheckBoxChange = function handleCheckBoxChange(place) {
    handleChangeEnabled(place === null || place === void 0 ? void 0 : place.id, {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles2.Container, null, /*#__PURE__*/_react.default.createElement(_styles2.PlaceContainer, null, /*#__PURE__*/_react.default.createElement(_styles2.Header, null, /*#__PURE__*/_react.default.createElement("h1", null, t('PLACES', 'Places')), /*#__PURE__*/_react.default.createElement(_styles.Button, {
  ...
  }, t('ADD_PLACES', 'Add places'))), placeList !== null && placeList !== void 0 && placeList.loading ? /*#__PURE__*/_react.default.createElement(_styles2.Content, null, _toConsumableArray(Array(5).keys()).map(function (i) {
  ...
  })) : /*#__PURE__*/_react.default.createElement(_styles2.Content, null, (placeList === null || placeList === void 0 ? void 0 : (_placeList$places = placeList.places) === null || _placeList$places === void 0 ? void 0 : _placeList$places.length) > 0 && /*#__PURE__*/_react.default.createElement(_styles2.TableHead, null, /*#__PURE__*/_react.default.createElement(_styles2.CheckWrapper, null, /*#__PURE__*/_react.default.createElement("span", {
    className: "check-box",
    onClick: function onClick() {
    ...
    className: "active"
  }) : /*#__PURE__*/_react.default.createElement(_reactBootstrapIcons.Square, null)), /*#__PURE__*/_react.default.createElement("label", null, t('PLACES', 'Places')))), placeList === null || placeList === void 0 ? void 0 : (_placeList$places2 = placeList.places) === null || _placeList$places2 === void 0 ? void 0 : _placeList$places2.map(function (place, i) {
    return /*#__PURE__*/_react.default.createElement(_styles2.PlaceItemContainer, {
      key: i,
  ...
  }, t('ADD_PLACES', 'Add places')))), width >= 1000 ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, openDetail && /*#__PURE__*/_react.default.createElement(_BusinessPlace.BusinessPlace, {
...
exports.BusinessPlaceListUI = BusinessPlaceListUI;
...
var BusinessPlaceList = function BusinessPlaceList(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_orderingComponentsAdmin.BusinessPlaceList, businessPlaceListProps);
};
