...
var WrapperNotFound = exports.WrapperNotFound = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  font-size: 16px;\n  text-align: center;\n  font-weight: 500;\n  margin: 20px;\n"])));
var AddProductBtnWrapper = exports.AddProductBtnWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  margin-top: 12px;\n  margin-bottom: 15px;\n"])));
var ProductListBottom = exports.ProductListBottom = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-between;\n  align-items: center;\n  margin-top: 20px;\n  \n  @media (min-width: 768px) {\n    ", "\n  }\n"])), function (props) {
  var _props$theme;
