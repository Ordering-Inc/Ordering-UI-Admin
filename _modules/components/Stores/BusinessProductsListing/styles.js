...
var CategoryListContainer = exports.CategoryListContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  min-width: 260px;\n\n  @media (max-width: 576px) {\n    width:100%;\n  }\n"])));
var ProductListContainer = exports.ProductListContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  flex-grow: 1;\n  width: 100%;\n\n  @media (min-width: 769px) {\n    width: calc(100% - 260px);\n  }\n"])));
var ProductHeader = exports.ProductHeader = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n\n  h1 {\n    font-weight: 600;\n    font-size: 14px;\n    margin: 0;\n  }\n\n  @media (min-width: 768px) {\n    padding: 0 10px;\n\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var ActionIconList = exports.ActionIconList = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  button.batch-image-upload {\n    border: 1px solid ", ";\n    background-color: transparent;\n    color: ", ";\n    padding: 4px 15px;\n    &:hover {\n      background: ", ";\n      color: ", ";\n    }\n  }\n"])), function (props) {
...
var ViewMethodButton = exports.ViewMethodButton = _styledComponents.default.span(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  margin-left: 12px;\n  cursor: pointer;\n  color: ", ";\n\n  svg {\n    font-size: 16px;\n  }\n\n  &.batch {\n    svg {\n      font-size: 18px;\n    }\n  }\n\n  ", "\n"])), function (props) {
...
var BusinessSelector = exports.BusinessSelector = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: relative;\n  width: fit-content;\n"])));
var BusinessNameWrapper = exports.BusinessNameWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  h1 {\n    font-size: 20px;\n    font-weight: 700;\n  }\n  cursor: pointer;\n  h1 {\n    svg {\n      font-size: 0.7em;\n      transition: 0.2s ease-in-out;\n    }\n    svg.rotate-arrow {\n      transform: rotate(180deg);\n    }\n  }\n"])));
var Breadcrumb = exports.Breadcrumb = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  font-size: 12px;\n  color: ", ";\n\n  span {\n    &.business {\n      color: ", ";\n      cursor: pointer;\n    }\n  }\n\n  svg {\n    margin: 0 9px;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
  return props.theme.colors.primary;
});
var ColumnsAllowWrapper = exports.ColumnsAllowWrapper = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  position: relative;\n  margin: 0 5px;\n"])));
