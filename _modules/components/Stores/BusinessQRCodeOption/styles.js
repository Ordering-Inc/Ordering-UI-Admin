...
var FormControl = exports.FormControl = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  label {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-bottom: 6px;\n  }\n  input {\n    width: 100%;\n    height: 44px;\n  }\n\n  ", "\n"])), function (_ref) {
  var isMargin = _ref.isMargin;
  return isMargin && (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n    margin-top: 10px;\n  "])));
});
var QRCodeLayout = exports.QRCodeLayout = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin-bottom: 20px;\n"])));
var TableNumberHintText = exports.TableNumberHintText = _styledComponents.default.span(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  font-weight: 400;\n  font-size: 14px;\n  line-height: 18px;\n  margin-bottom: 15px;\n  color: ", ";\n"])), function (props) {
