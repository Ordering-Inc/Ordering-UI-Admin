...
var InstagramGeneralContainer = exports.InstagramGeneralContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  > p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    color: ", ";\n    margin-bottom: 23px;\n    margin-top: 0;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
var Step = exports.Step = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin-bottom: 27px;\n  h3 {\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    margin-top: 0;\n    margin-bottom: 12px;\n  }\n  p {\n    font-weight: 400;\n    font-size: 14px;\n    line-height: 24px;\n    margin-top: 0;\n    margin-bottom: 20px;\n    color: ", ";\n  }\n  > img {\n    width: 100%;\n  }\n\n  @media (min-width: 576px) {\n    > img {\n      display: block;\n      width: 90%;\n      margin-left: auto;\n      margin-right: auto;\n      margin-bottom: 24px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
var CopyInputWrapper = exports.CopyInputWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  input {\n    flex: 1;\n    height: 44px;\n  }\n  button {\n    margin-left: 15px;\n    ", "\n  }\n  ", "\n"])), function (props) {
...
var InstagramAdvancedContainer = exports.InstagramAdvancedContainer = (0, _styledComponents.default)(InstagramGeneralContainer)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral([""])));
var ImageWrapper = exports.ImageWrapper = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-direction: column;\n  img {\n    width: 100%;\n    margin-bottom: 15px;\n  }\n\n  @media (min-width: 576px) {\n    flex-direction: row;\n    img {\n      width: 48%;\n      margin-bottom: 0px;\n    }\n  }\n"])));