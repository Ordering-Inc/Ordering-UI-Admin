...
var ButtonGroup = exports.ButtonGroup = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-end;\n  flex-direction: column;\n  > div {\n    width: 100%;\n  }\n\n  @media (min-width: 769px) {\n    flex-direction: row;\n    align-items: center;\n    ", "\n  }\n\n  > button {\n    height: 42px;\n    display: flex;\n    align-items: center;\n    svg {\n      min-width: 14px;\n      margin-left: 5px;\n      ", "\n    }\n  }\n"])), function (_ref3) {
  ...
  return isSelect && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n      > div {\n        width: calc(100% - 100px);\n      }\n    "])));
}, function (props) {
  return props.theme.rtl && (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n        margin-left: 0px;\n        margin-right: 5px;\n      "])));
});
var EmptyBusinessWrapper = exports.EmptyBusinessWrapper = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  min-height: calc(100vh - 140px);\n\n  > img {\n    width: 90%;\n    max-width: 500px;\n  }\n\n  button {\n    height: 44px;\n    margin-top: 30px;\n  }\n  @media (min-width: 576px) {\n    > img {\n      width: 60%;\n    }\n  }\n"])));