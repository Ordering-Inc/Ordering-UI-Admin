...
var Option = exports.Option = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  ", "\n  ", "\n"])), function (_ref) {
  ...
  return isWeight && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    font-weight: 600;\n  "])));
});
var TypeSelectWrapper = exports.TypeSelectWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  > div {\n    max-width: 100%;\n    min-width: 100%;\n    padding: 3.5px 15px;\n    margin-bottom: 10px;\n  }\n"])));