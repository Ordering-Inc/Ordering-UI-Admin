...
var FormContainer = exports.FormContainer = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n\n  > button {\n    height: 44px;\n    margin-top: 20px;\n  }\n"])));
var FormController = exports.FormController = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 25px;\n\n  label {\n    font-size: 14px;\n    margin-bottom: 10px;\n  }\n"])));
var SandboxWrapper = exports.SandboxWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 10px 0 25px;\n\n  > span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var EmptyMessage = exports.EmptyMessage = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  padding: 15px 0;\n"])));