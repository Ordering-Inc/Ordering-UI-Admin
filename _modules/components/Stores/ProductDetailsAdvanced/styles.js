...
var LabelCustom = exports.LabelCustom = _styledComponents.default.label(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  margin-top: 30px;\n  margin-bottom: 10px;\n  font-size: 14px;\n"])));
var ButtonGroup = exports.ButtonGroup = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 40px;\n\n  button {\n    padding-top: 5px;\n    padding-bottom: 5px;\n\n    &:last-child {\n      ", "\n    }\n  }\n"])), function (props) {
  var _props$theme;
...
var EditTaxContainer = exports.EditTaxContainer = _styledComponents.default.form(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-between;\n\n  & > div {\n    width: 48%;\n  }\n\n  @media (max-width: 576px) {\n    flex-direction: column;\n    & > div {\n      width: 100%;\n    }\n  }\n"])));
var WrapperRow = exports.WrapperRow = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100% !important;\n  flex-direction: column;\n  justify-content: space-between;\n\n  & > div {\n    width: 100%;\n    height: 100px;\n    margin-bottom: 20px;\n    border: none;\n  }\n\n  .date-filter-container {\n    z-index: 100;\n  }\n\n  > input {\n    width: 100%;\n    height: 57px;\n    margin-bottom: 20px;\n    padding: 10px 25px;\n    box-sizing: border-box;\n    &::-webkit-outer-spin-button,\n    &::-webkit-inner-spin-button {\n      -webkit-appearance: none;\n      margin: 0;\n    }\n    -moz-appearance: textfield;\n  }\n\n  @media (min-width: 992px) {\n    flex-direction: row;\n    & > div {\n      width: 48%;\n    }\n\n    > input {\n      width: 48%;\n    }\n  }\n"])));
var FieldRow = exports.FieldRow = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-direction: column;\n  label:first-child{\n    margin-top: 30px;\n  }\n  > div {\n    width: 100%;\n    padding: 0px;\n  }\n\n  @media (min-width: 576px) {\n    flex-direction: row;\n    > div {\n      width: 48%;\n    }\n    ", "\n  }\n"])), function (_ref5) {
  var fullWidth = _ref5.fullWidth;
  return fullWidth && (0, _styledComponents.css)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n      > div {\n        width: 100%;\n      }\n    "])));
});
var InputContainer = exports.InputContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  max-width: 100%;\n  padding: 0 10px;\n\n  &.growUnset {\n    flex-grow: unset;\n  }\n\n  &.showWeight {\n    width: 40%;\n  }\n"])));
var WeightWrapper = exports.WeightWrapper = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n\n  input {\n    width: 55%;\n  }\n\n  .select {\n    width: 40%;\n    padding-top: 3.5px;\n    font-size: 14px;\n\n    .list {\n      padding-top: 7px;\n      padding-bottom: 7px;\n      margin-bottom: 10px;\n    }\n  }\n"])));
var PropertyOptionWrapper = exports.PropertyOptionWrapper = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: block;\n  margin-top: 30px;\n"])));
var PricePerUnit = exports.PricePerUnit = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  label {\n    font-size: 14px;\n    margin: 0;\n    margin-right: 15px;\n    ", "\n  }\n  \n  .select {\n    font-size: 14px;\n    padding: 3.5px;\n    .list {\n      padding-top: 7px;\n      padding-bottom: 7px;\n    }\n  }\n"])), function (props) {
  var _props$theme2;
