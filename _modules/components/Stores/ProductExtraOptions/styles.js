...
var OptionImage = exports.OptionImage = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: 30px;\n  height: 30px;\n  min-width: 30px;\n  border-radius: 8px;\n  overflow: hidden;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  position: relative;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: ", ";\n\n  img {\n    width: 100%;\n    border-radius: 8px;\n    height: 100%;\n    object-fit: cover;\n    overflow: hidden;\n  }\n\n  svg {\n    font-size: 20px;\n    color: #ADB5BD;\n  }\n\n  ", "\n\n  @media (min-width: 450px) {\n    width: 38px;\n    height: 38px;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme5;
...
var AddOptionForm = exports.AddOptionForm = _styledComponents.default.form(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  border-top: 13px solid ", ";\n  border-bottom: 1px solid ", ";\n\n  > input {\n    width: 75px;\n    height: 32px;\n    padding: 5px;\n    border: none;\n    outline: none;\n    font-size: 14px;\n    background: ", ";\n\n    &:focus {\n      border: 1px dashed ", ";\n    }\n  }\n\n  @media (min-width: 450px) {\n    > input {\n      width: 80px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
...
var OptionsList = exports.OptionsList = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n"])));
var OptionItem = exports.OptionItem = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid ", ";\n\n  ", "\n  ", "\n\n  ", "\n\n  ", "\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref2) {
  ...
  return isDragOver && (0, _styledComponents.css)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n    border-top: 1px solid ", ";\n  "])), function (props) {
    return props.theme.colors.primary;
  });
}, function (_ref5) {
  var isBorderBottom = _ref5.isBorderBottom;
  return isBorderBottom && (0, _styledComponents.css)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n    border-bottom: 1px solid ", ";\n  "])), function (props) {
    return props.theme.colors.primary;
  });
});
var MinimumPurchase = exports.MinimumPurchase = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  min-width: 75px;\n  ", "\n  @media (min-width: 450px) {\n    min-width: 80px;\n  }\n"])), function (_ref6) {
...
var MaxPurchase = exports.MaxPurchase = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  min-width: 75px;\n  ", "\n  @media (min-width: 450px) {\n    min-width: 80px;\n  }\n"])), function (_ref7) {
  var isHeader = _ref7.isHeader;
  return isHeader ? (0, _styledComponents.css)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n    font-size: 12px;\n    font-weight: 700;\n  "]))) : (0, _styledComponents.css)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    font-size: 14px;\n  "])));
});
var ArrowWrpper = exports.ArrowWrpper = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  width: 30px;\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  svg {\n    font-size: 13px;\n    color: ", ";\n    margin: 0 5px;\n  }\n"])), function (props) {
