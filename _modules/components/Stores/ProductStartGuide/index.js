...
var ProductStartGuide = function ProductStartGuide(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.Container, null, /*#__PURE__*/_react.default.createElement("h2", null, t('HOW_DO_YOU_WANT_TO_START', 'How do you want to start?')), guideList.map(function (guide) {
    return /*#__PURE__*/_react.default.createElement(_styles.GuideItemContainer, {
      key: guide.id,
      onClick: function onClick() {
        return handleChangeStep(guide.id);
      }
    }, guide.icon, /*#__PURE__*/_react.default.createElement(_styles.InfoWrapper, null, /*#__PURE__*/_react.default.createElement("h3", null, guide.title), /*#__PURE__*/_react.default.createElement("p", null, guide.description)));
  }));
};
