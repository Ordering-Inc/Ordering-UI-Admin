...
exports.InfoWrapper = exports.GuideItemContainer = exports.Container = void 0;
...
var GuideItemContainer = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 10px 20px;\n  min-height: 78px;\n  margin-top: 30px;\n  border-radius: 7.6px;\n  cursor: pointer;\n  border: 1px solid ", ";\n  transition: all 0.3s linear;\n\n  &:hover {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n\n  svg {\n    font-size: 24px;\n    margin-right: 20px;\n    ", "\n  }\n"])), function (props) {
