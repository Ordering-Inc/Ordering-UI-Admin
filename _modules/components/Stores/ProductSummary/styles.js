...
var ProductImageStyled = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n"])));
...
var ProductDetailsContent = exports.ProductDetailsContent = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  margin: 20px 0;\n"])));
var ProductPrice = exports.ProductPrice = _styledComponents.default.p(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  font-size: 20px;\n  font-weight: 600;\n  margin: 30px 0 15px;\n  color: ", ";\n  span {\n    font-size: 18px;\n    font-weight: 300;\n    color: ", ";\n    text-decoration: line-through;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
...
var ProductDescription = exports.ProductDescription = _styledComponents.default.p(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  word-break: break-word;\n  font-size: 14px;\n  color: ", ";\n  margin-bottom: 27px;\n"])), function (props) {
  return props.theme.colors.headingColor;
});
var ProductConfigsContainer = exports.ProductConfigsContainer = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  border: 1px solid ", ";\n  border-radius: 8px;\n  margin-bottom: 50px;\n  overflow: hidden;\n  > div:first-child {\n    border-top: none !important;\n  }\n\n  > div:last-child {\n    border-bottom: none !important;\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
});
var ProductConfigOption = exports.ProductConfigOption = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  padding: 13px 15px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  color: ", ";\n  border-bottom: 1px solid ", ";\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", "\n\n  span {\n    font-size: 12px;\n  }\n  svg {\n    font-size: 14px;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
...
var ProductPreviewHeader = exports.ProductPreviewHeader = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  border-right: 1px solid ", ";\n  ", "\n\n  h1 {\n    font-size: 20px;\n    font-weight: 700;\n    margin: 0;\n  }\n  > div {\n    display: flex;\n    button {\n      margin: 0 5px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  var _props$theme3;
...
var ProductSummaryContent = exports.ProductSummaryContent = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  @media (min-width: 768px) {\n    flex-direction: row;\n    align-items: center;\n    justify-content: space-between;\n  }\n"])));
var ProductSales = exports.ProductSales = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 100%;\n  height: 90px;\n  padding: 10px;\n  border: 1px solid #E9ECEF;\n  box-sizing: border-box;\n  border-radius: 7.6px;\n\n  @media (min-width: 768px) {\n    width: 230px;\n  }\n"])));
var RolWrapper = exports.RolWrapper = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  margin-left: 20px;\n  ", "\n\n  h4 {\n    font-size: 20px;\n    font-weight: 600;\n    margin: 0;\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    ", ";\n  }\n\n  p {\n    margin: 0;\n    font-size: 12px;\n    line-height: 18px;\n    ", ";\n  }\n"])), function (props) {
  var _props$theme4;
...
var ProductDetails = exports.ProductDetails = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  padding: 10px 0;\n"])));
var FieldsItem = exports.FieldsItem = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  width: 48%;\n  margin-bottom: 25px;\n\n  h4 {\n    margin: 0;\n    font-weight: 600;\n    font-size: 16px;\n    line-height: 24px;\n    ", ";\n  }\n\n  p {\n    margin: 0;\n    font-size: 12px;\n    line-height: 18px;\n    ", ";\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.colors.lightGray;
});
var PriceDuration = exports.PriceDuration = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  display: flex;\n  font-weight: 600;\n  font-size: 20px;\n  margin-bottom: 15px;\n\n  .dot {\n    margin: 0px 5px;\n  }\n"])));