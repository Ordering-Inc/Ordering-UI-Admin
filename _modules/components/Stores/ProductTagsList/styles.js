...
var TagImageWrapper = exports.TagImageWrapper = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  margin: 0 14px;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 8px;\n  width: 32px;\n  height: 32px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: ", ";\n\n  img {\n    width: 100%;\n    height: 100%;\n    border-radius: 8px;\n  }\n  svg {\n    font-size: 16px;\n  }\n"])), function (props) {
  return props.theme.colors.gray;
});
var AddNewLabel = exports.AddNewLabel = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  margin: 15px 0;\n"])));