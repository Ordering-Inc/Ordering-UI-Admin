...
var ServiceDetail = exports.ServiceDetail = function ServiceDetail(props) {
  ...
  var _useState9 = (0, _react.useState)({}),
    ...
    curPreorderTime = _useState0[0],
    setCurPreorderTime = _useState0[1];
  var _useState1 = (0, _react.useState)(false),
    _useState10 = _slicedToArray(_useState1, 2),
    isCustom = _useState10[0],
    setIsCustom = _useState10[1];
  var _useState11 = (0, _react.useState)({
      isAutoGenerate: false,
      autoCodeText: product === null || product === void 0 ? void 0 : product.slug
    }),
    _useState12 = _slicedToArray(_useState11, 2),
    autoGenerateCode = _useState12[0],
    setAutoGenerate = _useState12[1];
  var durationList = [{
    value: 15,
