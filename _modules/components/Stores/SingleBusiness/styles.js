...
var InfoBlock = exports.InfoBlock = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  ", "\n  p {\n    margin: 5px 0 0 0;\n    font-size: 12px;\n    color: ", ";\n  }\n  p.bold {\n    margin: 0px;\n    font-size: 14px;\n    font-weight: 600;\n    color: ", ";\n  }\n  p.star {\n    margin: 0px;\n    display: flex;\n    align-items: center;\n    svg {\n      font-size: 16px;\n      color: ", ";\n    }\n    span {\n      font-size: 14px;\n      color: ", ";\n      ", "\n    }\n  }\n\n  > span {\n    font-size: 14px;\n  }\n\n  ", "\n"])), function (props) {
  ...
  return width && (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n    width: ", "px\n  "])), width);
});
...
var SingleBusinessCardContainer = exports.SingleBusinessCardContainer = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  ", "\n  border: 1px solid #E9ECEF;\n  box-sizing: border-box;\n  border-radius: 8px;\n\n  margin: 10px;\n  width: calc(100% - 20px);\n\n  @media (min-width: 768px) {\n    width: calc(50% - 20px);\n  }\n\n  @media (min-width: 992px) {\n    width: calc(33.33% - 20px);\n  }\n\n  @media (min-width: 1024px) {\n    width: calc(25% - 20px);\n  }\n  @media (min-width: 1250px) {\n    width: calc(20% - 20px);\n  }\n"])), function (_ref4) {
...
var BusinessHeaderStyled = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  width: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  height: 100px;\n  border-top-right-radius: 8px;\n  border-top-left-radius: 8px;\n  ", "\n"])), function (_ref5) {
...
var BusinessContent = exports.BusinessContent = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  padding: 40px 10px 10px 10px;\n  h1, p {\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n  h1 {\n    font-size: 14px;\n    margin-bottom: 5px;\n    color: ", ";\n  }\n\n  p {\n    font-size: 12px;\n    margin: 0px;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.colors.lightGray;
});
var BusinessActionContainer = exports.BusinessActionContainer = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  border-top: 1px solid ", ";\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 10px;\n  padding-top: 10px;\n\n  > span {\n    font-size: 14px;\n  }\n"])), function (props) {
  return props.theme.colors.secundary;
});
var BusinessHeaderContent = exports.BusinessHeaderContent = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  position: absolute;\n  bottom: -22px;\n  width: 100%;\n  padding: 0 15px;\n"])));
var BusinessIdWrapper = exports.BusinessIdWrapper = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));
var CheckBoxWrapper = exports.CheckBoxWrapper = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  display: flex;\n  ", "\n  svg {\n    font-size: 16px;\n    color: ", ";\n  }\n\n  ", "\n"])), function (props) {
  var _props$theme5;
  ...
  return isChecked && (0, _styledComponents.css)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n    svg {\n      color: ", ";\n    }\n  "])), function (props) {
    var _props$theme$colors;
    return (_props$theme$colors = props.theme.colors) === null || _props$theme$colors === void 0 ? void 0 : _props$theme$colors.primary;
  });
});
var FeaturedWrapper = exports.FeaturedWrapper = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n"])));