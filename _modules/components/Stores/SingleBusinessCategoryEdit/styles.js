...
var CategoryActionContainer = exports.CategoryActionContainer = _styledComponents.default.div(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 4px;\n  > div:first-child {\n    padding: 0 5px;\n  }\n"])));
var CategoryEnableWrapper = exports.CategoryEnableWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n\n  span {\n    font-size: 14px;\n    color: ", ";\n    font-size: 12px;\n    margin: 0px;\n    ", "\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  var _props$theme2;
...
var DraggableContainer = exports.DraggableContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  > img {\n    ", "\n\n    &:hover {\n      cursor: grab;\n    }\n  }\n"])), function (props) {
  var _props$theme3;
