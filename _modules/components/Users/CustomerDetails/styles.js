...
var PhotoWrapper = exports.PhotoWrapper = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  width: 216px;\n  height: 216px;\n  margin: 30px 0;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 8px;\n  overflow: hidden;\n\n  img {\n    width: 100%;\n    height: 100%;\n    object-fit: cover;\n  }\n\n  span {\n    height: 100%;\n    width: 100%;\n    position: relative;\n    top: -2px;\n  }\n\n  svg {\n    width: 100%;\n    height: 100%;\n  }\n"])));
var MenusContainer = exports.MenusContainer = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  margin-top: 50px;\n  border: 1px solid ", ";\n  border-radius: 8px;\n  overflow: hidden;\n  ", "\n  > div:first-child {\n    border-top: none !important;\n  }\n  > div:last-child {\n    border-bottom: none !important;\n  } \n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (_ref) {
  var isLoading = _ref.isLoading;
  return isLoading && (0, _styledComponents.css)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});
var OptionMenu = exports.OptionMenu = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  padding: 10px 16px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  color: ", ";\n  border-bottom: 1px solid ", ";\n  border-top: 1px solid transparent;\n  &:hover {\n    background-color: ", ";\n  }\n  span {\n    font-size: 14px;\n  }\n  svg {\n    font-size: 16px;\n  }\n  ", "\n"])), function (props) {
...
var UserDetailsWrapper = exports.UserDetailsWrapper = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 100%;\n  padding: 20px;\n"])));
var UserName = exports.UserName = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n\n  > label {\n    margin-left: 10px;\n    ", "\n  }\n"])), function (props) {
