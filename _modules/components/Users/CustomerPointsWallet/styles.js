...
var LoyaltyLevel = exports.LoyaltyLevel = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  h2 {\n    font-weight: 600;\n    font-size: 16px;\n    margin-top: 50px;\n    margin-bottom: 25px;\n  }\n"])));
var LoyaltyLevelContent = exports.LoyaltyLevelContent = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: 100%;\n  max-width: 359px;\n\n  img {\n    width: 100%;\n    object-fit: cover;\n  }\n\n  h3 {\n    font-weight: 600;\n    font-size: 28px;\n    line-height: 42px;\n    color: ", ";\n    margin-top: 15px;\n    text-align: center;\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
var SectionContainer = exports.SectionContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  margin-top: 54px;\n  margin-bottom: 30px;\n  > p {\n    font-size: 16px;\n    font-weight: 600;\n    margin-top: 0;\n    margin-bottom: 22px;\n  }\n  > button {\n    height: 44px;\n  }\n"])));
var FormController = exports.FormController = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 26px;\n\n  label {\n    font-size: 14px;\n    margin-bottom: 10px;\n  }\n\n  input,\n  textarea {\n    font-size: 14px;\n  }\n\n  input::-webkit-outer-spin-button,\n  input::-webkit-inner-spin-button {\n    -webkit-appearance: none;\n    margin: 0;\n  }\n\n  input[type=number] {\n    -moz-appearance: textfield;\n  }\n"])));