...
var TransactionDescription = exports.TransactionDescription = _styledComponents.default.p(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  color: ", ";\n  font-size: 12px;\n  margin: 0;\n  ", "\n"])), function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
  var _props$theme3;
...
var Amount = exports.Amount = _styledComponents.default.span(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  font-weight: 500;\n  ", "\n"])), function (_ref2) {
  var negative = _ref2.negative;
  return !negative && (0, _styledComponents.css)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    color: ", ";\n  "])), function (props) {
    return props.theme.colors.primary;
  });
});
var TransactionCode = exports.TransactionCode = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: ", ";\n  ", "\n"])), function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
  var _props$theme4;
