...
exports.VerifiedStatusFilterContainer = VerifiedStatusFilterContainer;
var ActionButtonsGroup = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 15px;\n  button {\n    height: 44px;\n  }\n  > * {\n    &:not(:last-child) {\n      ", "\n    }\n  }\n\n  @media (min-width: 768px) {\n    margin-top: 0;\n  }\n"])), function (props) {
  var _props$theme3;
