...
var SideBarWrapper = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  max-width: 500px;\n  height: 100%;\n  padding: 35px 20px;\n  width: 100%;\n  > h1 {\n    font-size: 20px;\n    font-weight: 700;\n    margin-bottom: 25px;\n  }\n  > div {\n    padding: 0px;\n    height: calc(100% - 50px);\n  }\n"])));
exports.SideBarWrapper = SideBarWrapper;
var CalendarSyncWrapper = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  margin: 0 10px;\n  > button {\n    height: 44px;\n    span {\n      ", "\n    }\n  }\n"])), function (props) {
  var _props$theme2;
...
exports.CalendarSyncWrapper = CalendarSyncWrapper;