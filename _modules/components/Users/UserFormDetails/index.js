...
var UserFormDetailsUI = exports.UserFormDetailsUI = function UserFormDetailsUI(props) {
  ...
  var _useState9 = (0, _react.useState)(''),
    ...
    timezoneSearchValue = _useState0[0],
    setTimezoneSearchValue = _useState0[1];
  var _useCustomer = (0, _orderingComponentsAdmin.useCustomer)(),
    _useCustomer2 = _slicedToArray(_useCustomer, 2),
    setUserCustomer = _useCustomer2[1].setUserCustomer;
  var emailInput = (0, _react.useRef)(null);
  var _useState1 = (0, _react.useState)(userData),
    _useState10 = _slicedToArray(_useState1, 2),
    user = _useState10[0],
    setUser = _useState10[1];
  var _useState11 = (0, _react.useState)(false),
    _useState12 = _slicedToArray(_useState11, 2),
    passwordSee = _useState12[0],
    setPasswordSee = _useState12[1];
