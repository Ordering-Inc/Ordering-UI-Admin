...
exports.ActionContainer = exports.HeaderTitleContainer = exports.HeaderContainer = void 0;
...
var ActionContainer = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  margin-top: 20px;\n\n  > *:not(:last-child) {\n    ", "\n  }\n\n  input {\n    background: ", ";\n    border: none;\n  }\n\n  button {\n    height: 41px;\n  }\n\n  @media (min-width: 768px) {\n    margin-top: 0px;\n  }\n"])), function (props) {
  var _props$theme2;
