...
var SingleCard = _styledComponents.default.div(_templateObject(), function (props) {
  ...
  return (props.theme.colors.backgroundPage === '#FFF' || props.theme.colors.backgroundPage === '#FFFFFF') && (0, _styledComponents.css)(_templateObject3());
});

exports.SingleCard = SingleCard;

var OrderPastContent = _styledComponents.default.div(_templateObject4(), function (props) {
  var _props$theme;
...
var PastLogo = _styledComponents.default.div(_templateObject6());

exports.PastLogo = PastLogo;

var WrapperBusinessTitle = _styledComponents.default.div(_templateObject7());

exports.WrapperBusinessTitle = WrapperBusinessTitle;

var Reorder = _styledComponents.default.div(_templateObject8(), function (props) {
  var _props$theme2;
...
var WrappButton = _styledComponents.default.div(_templateObject12());
