...
var InfoShareProvider = function InfoShareProvider(_ref) {
  ...
  var _useState = (0, _react.useState)({
    isCollapse: false
      ...
      infoState = _useState2[0],
      setInfoState = _useState2[1];

  var handleMenuCollapse = function handleMenuCollapse(val) {
  ...
  return /*#__PURE__*/_react.default.createElement(InfoShareContext.Provider, {
    value: [infoState, functions]
  }, children);
}; // hook context
