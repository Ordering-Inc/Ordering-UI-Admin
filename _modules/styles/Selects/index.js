...
var Select = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  display: inline-block;\n  border-radius: 7.6px;\n  line-height: 34px;\n  border-width: 1px;\n  border-style: solid;\n  border-color: #DEE2E6;\n  color: #344050;\n  position: relative;\n\n  ", "\n\n  ", "\n\n  ", "\n"])), function (props) {
...
var Chevron = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  display: flex;\n  align-items: center;\n  margin-left: 5px;\n  ", "\n"])), function (props) {
  var _props$theme4;
...
var Header = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  flex: 1;\n  overflow: auto;\n  white-space: nowrap;\n  display: flex;\n  align-items: center;\n"])));

exports.Header = Header;

var SelectImage = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  width: 28px;\n  height: 28px;\n  border-radius: 1000px;\n  margin-left: 5px;\n  overflow: hidden;\n\n  ", "\n\n  img {\n    width: 100%;\n    height: 100%;\n  }\n"])), function (props) {
  var _props$theme5;
...
var MultiSelectOption = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  position: relative;\n  button {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    position: absolute;\n    background: ", ";\n    width: 20px;\n    height: 20px;\n    transform: translate(100%, -50%);\n    top: 11px;\n    right: 15px;\n  }\n"])), function (props) {
...
var FunctionalityContainer = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  svg{\n    margin-left: 20px;\n    ", "\n  }\n"])), function (props) {
...
var SearchBarWrapper = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  padding: 5px 10px;\n  width: 100%;\n  > div {\n    input {\n      height: 42px;\n    }\n  }\n"])));

exports.SearchBarWrapper = SearchBarWrapper;

var MultiOption = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 5px 10px;\n  box-sizing: border-box;\n  min-width: ", ";\n  color: #333;\n  cursor: pointer;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", "\n\n  svg {\n    vertical-align: text-top;\n  }\n\n  ", "\n\n  ", "\n"])), function (_ref15) {
