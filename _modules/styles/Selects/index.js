...
var Options = exports.Options = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  min-width: ", ";\n  background: ", ";\n  z-index: 10000;\n  border-width: 1px;\n  border-style: solid;\n  border-color: #E9ECEF;\n  border-radius: 7.6px;\n  overflow: hidden;\n\n  ", "\n  ", "\n\n  ", "\n"])), function (_ref7) {
  ...
  return (position === null || position === void 0 ? void 0 : position.toLowerCase()) === 'left' && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    left: 0;\n    margin-left: -1px;\n    ", "\n  "])), function (props) {
    var _props$theme2;
  ...
  var isAbsolute = _ref0.isAbsolute;
  return isAbsolute && (0, _styledComponents.css)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n    position: absolute;\n    margin-top: 7px;\n  "])));
});
var OptionsInner = exports.OptionsInner = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  overflow-x: hidden;\n  margin: ", ";\n  max-height: ", ";\n  overscroll-behavior: contain;\n"])), function (_ref1) {
  var optionInnerMargin = _ref1.optionInnerMargin;
  return optionInnerMargin;
}, function (_ref10) {
  var optionInnerMaxHeight = _ref10.optionInnerMaxHeight;
  return optionInnerMaxHeight;
});
var Selected = exports.Selected = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  ", "\n  cursor: pointer;\n  position: relative;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex: 1;\n\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n  -khtml-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n  z-index: 11;\n\n  p {\n    margin: 0px;\n  }\n\n  @media (max-width: 380px) {\n    padding-left: 9px;\n    padding-right: 9px;\n    font-size: 13px;\n  }\n\n  ", "\n"])), function (_ref11) {
  var useTextStyle = _ref11.useTextStyle;
  return !useTextStyle && (0, _styledComponents.css)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n    padding-left: 15px;\n    padding-right: 15px;\n  "])));
}, function (_ref12) {
...
var Select = exports.Select = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: inline-block;\n  color: #344050;\n  position: relative;\n\n  ", "\n  ", "\n\n  ", "\n\n  ", "\n"])), function (props) {
  return !props.useTextStyle && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    border-radius: 7.6px;\n    line-height: 34px;\n    border-width: 1px;\n    border-style: solid;\n    border-color: #DEE2E6;\n  "])));
}, function (props) {
...
var Header = exports.Header = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  flex: 1;\n  overflow: auto;\n  white-space: ", ";\n  display: flex;\n  align-items: center;\n"])), function (_ref15) {
  var useTextStyle = _ref15.useTextStyle;
...
var MultiOption = exports.MultiOption = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 5px 10px;\n  box-sizing: border-box;\n  min-width: ", ";\n  color: #333;\n  cursor: pointer;\n\n  ", "\n\n  ", "\n\n  ", "\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", "\n\n  svg {\n    vertical-align: text-top;\n  }\n\n  ", "\n\n  ", "\n"])), function (_ref16) {
  ...
  var withIcons = _ref20.withIcons;
