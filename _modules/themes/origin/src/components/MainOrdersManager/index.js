...
var MainOrdersManagerUI = function MainOrdersManagerUI(props) {
  ...
  var _useState9 = (0, _react.useState)(null),
    ...
    orderIdForUnreadCountUpdate = _useState0[0],
    setOrderIdForUnreadCountUpdate = _useState0[1];
  var _useState1 = (0, _react.useState)(0),
    _useState10 = _slicedToArray(_useState1, 2),
    totalSelectedOrder = _useState10[0],
    setTotalSelectedOrder = _useState10[1];
  var _useState11 = (0, _react.useState)(false),
    _useState12 = _slicedToArray(_useState11, 2),
    notificationModalOpen = _useState12[0],
    setNotificationModalOpen = _useState12[1];
  var _useState13 = (0, _react.useState)([]),
    _useState14 = _slicedToArray(_useState13, 2),
    registerOrderIds = _useState14[0],
    setRegisterOrderIds = _useState14[1];
  var _useState15 = (0, _react.useState)({
    ...
    activeSwitch = _useState16[0],
    setActiveSwitch = _useState16[1];
