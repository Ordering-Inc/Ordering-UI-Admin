...
var ModalHeader = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
exports.ModalHeader = ModalHeader;
var ModalTitle = _styledComponents.default.h2(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  text-align: left;\n  font-size: 30px;\n  font-weight: 500;\n  letter-spacing: 0px;\n  color: #010300;\n  opacity: 1;\n  margin: 0px 0px;\n  margin-bottom: 20px;\n  text-transform: capitalize;\n  flex: 1;\n  ", "\n"])), function (props) {
  var _props$theme;
