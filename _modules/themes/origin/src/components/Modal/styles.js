...
var ModalIcon = exports.ModalIcon = _styledComponents.default.span(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n  position: absolute;\n  right: 20px;\n  top: 20px;\n  font-size: 30px;\n  cursor: pointer;\n  z-index: 1;\n  ", "\n"])), function (props) {
  var _props$theme3;
  return ((_props$theme3 = props.theme) === null || _props$theme3 === void 0 ? void 0 : _props$theme3.rtl) && (0, _styledComponents.css)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n    left: 5px;\n    right: initial;\n  "])));
});