...
var OrderItemAccordion = exports.OrderItemAccordion = function OrderItemAccordion(props) {
  ...
  var _useState9 = (0, _react.useState)(false),
    ...
    setIsChecked = _useState0[1];
  var checkbox = (0, _react.useRef)(null);
  // const content = useRef(null)
  var toggleBtn = (0, _react.useRef)(null);
  var driverSelectorRef = (0, _react.useRef)(null);
  var _useState1 = (0, _react.useState)(order !== null && order !== void 0 && order.delivery_datetime_utc ? getTimeAgo(order === null || order === void 0 ? void 0 : order.delivery_datetime_utc) : getTimeAgo(order === null || order === void 0 ? void 0 : order.delivery_datetime, {
      utc: false
    })),
