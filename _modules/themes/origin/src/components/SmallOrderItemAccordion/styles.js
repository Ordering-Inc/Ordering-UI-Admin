...
var WrapperAccordionImage = exports.WrapperAccordionImage = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  max-width: 50px;\n  max-height: 50px;\n  height: 50px;\n  width: 50px;\n  border: 1px solid #e3e3e3;\n  border-radius: 5px;\n  margin: 0px;\n\n  ", "\n\n  svg {\n    width: 100%;\n    height: 100%;\n    padding: 3px;\n    box-sizing: border-box;\n    border-radius: 50%;\n  }\n"])), function (_ref8) {
  ...
  return small && (0, _styledComponents.css)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n    width: 25px;\n    height: 25px;\n    border-radius: 5px;\n  "])));
});
var AccordionImageStyled = _styledComponents.default.div(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: contain;\n  object-fit: cover;\n  background-position: center;\n  border-radius: 5px;\n"])));
...
var BusinessContent = exports.BusinessContent = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  h1 {\n    color: #000000;\n    font-size: 14px;\n    margin: 0px;\n    line-height: 13px;\n  }\n  p {\n    color: #000000;\n    font-size: 12px;\n    margin: 0px;\n    max-width: 90px;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n  }\n"])));
var DeliveryInfo = exports.DeliveryInfo = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n\n  p {\n    color: #343434;\n    font-size: 12px;\n    margin: 0px;\n  }\n"])));
var DeliveryType = exports.DeliveryType = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  column-gap: 5px;\n  justify-content: flex-end;\n"])));
var DeliveryIcon = exports.DeliveryIcon = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  width: 14px;\n  height: 14px;\n  display: flex;\n\n  img {\n    width: 100%;\n    height: 100%;\n  }\n"])));
var DeliveryName = exports.DeliveryName = _styledComponents.default.p(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  margin: 0px;\n  color: #343434;\n  font-size: 12px;\n"])));
...
var DriverInfo = exports.DriverInfo = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  column-gap: 8px;\n  width: 48%;\n  font-size: 11px;\n  box-sizing: border-box;\n\n  > div {\n    width: 100%;\n  }\n"])));
var CustomerContent = exports.CustomerContent = _styledComponents.default.div(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  p {\n    color: #000;\n    margin: 0px;\n    white-space: nowrap;\n    max-width: 80px;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    &:first-child {\n      font-size: 11px;\n      font-weight: 500;\n    }\n    &:last-child {\n      font-size: 8px;\n    }\n  }\n"])));
var WrapperOrderStatus = exports.WrapperOrderStatus = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  padding-top: 10px;\n  > div {\n    width: 100%;\n    border-color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.btnDarkBlue;
});
var WrapperDriverSelector = exports.WrapperDriverSelector = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  > div {\n    width: 100%;\n    > div {\n      padding: 0 10px;\n    }\n  }\n"])));
var UnreadMessageIndicator = exports.UnreadMessageIndicator = _styledComponents.default.span(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  background: ", ";\n  color: #fff;\n  padding: 0px 3px;\n  border-radius: 12px;\n  min-width: 12px;\n  font-size: 12px;\n  text-align: center;\n"])), function (props) {
  return props.theme.colors.btnDarkBlue;
});
var OrderLabelItem = exports.OrderLabelItem = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  column-gap: 5px;\n  font-size: 12px;\n"])));
var MoreDetailsButton = exports.MoreDetailsButton = _styledComponents.default.p(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  font-size: 12px;\n  color: ", " !important;\n  text-decoration: underline;\n  cursor: pointer;\n  font-weight: 600;\n\n  &:hover {\n    color: ", " !important;\n  }\n"])), function (props) {
  return props.theme.colors.btnDarkBlue;
}, function (props) {
  return (0, _polished.darken)(0.07, props.theme.colors.btnDarkBlue);
});
var TimeAgo = exports.TimeAgo = _styledComponents.default.p(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  text-align: right;\n"])));
var WrapIndicator = exports.WrapIndicator = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: flex-end;\n"])));