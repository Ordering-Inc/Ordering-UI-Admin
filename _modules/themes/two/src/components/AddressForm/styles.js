...
var Title = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  font-size: 24px;\n  font-weight: 500;\n  color: ", ";\n  text-align: initial;\n  text-transform: capitalize;\n  margin-bottom: 10px;\n"])), function (props) {
  return props.theme.colors.headingColor;
});

exports.Title = Title;

var CloseButton = _styledComponents.default.span(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  position: fixed;\n  cursor: pointer;\n  background: #E9ECEF;\n  padding: 5px;\n  top: 10px;\n  ", "\n  svg {\n    font-size: 24px;\n  }\n"])), function (props) {
  var _props$theme5;
