...
var AnalyticsAvailableTimes = function AnalyticsAvailableTimes(props) {
  ...
  var generateLabels = function generateLabels() {
    ...
    if (availableTimesList === null || availableTimesList === void 0 ? void 0 : (_availableTimesList$d = availableTimesList.data) === null || _availableTimesList$d === void 0 ? void 0 : _availableTimesList$d.available) {
  ...
  var generateAvailableData = function generateAvailableData() {
    ...
    if (availableTimesList === null || availableTimesList === void 0 ? void 0 : (_availableTimesList$d3 = availableTimesList.data) === null || _availableTimesList$d3 === void 0 ? void 0 : _availableTimesList$d3.available) {
  ...
  var generateNotAvailableData = function generateNotAvailableData() {
    ...
    if (availableTimesList === null || availableTimesList === void 0 ? void 0 : (_availableTimesList$d5 = availableTimesList.data) === null || _availableTimesList$d5 === void 0 ? void 0 : _availableTimesList$d5.not_available) {
  ...
  }))), (availableTimesList === null || availableTimesList === void 0 ? void 0 : availableTimesList.loading) ? /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
    height: 150
