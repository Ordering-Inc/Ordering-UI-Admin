...
var AnalyticsFilterTimeZone = function AnalyticsFilterTimeZone(props) {
  ...
  var handleClickOutside = function handleClickOutside(e) {
    ...
    var outsideTimeZone = !((_timeZoneRef$current = timeZoneRef.current) === null || _timeZoneRef$current === void 0 ? void 0 : _timeZoneRef$current.contains(e.target));
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.AnalyticsTimeZoneContainer, null, /*#__PURE__*/_react.default.createElement(_Buttons.Button, {
    borderRadius: "7.6px",
    onClick: function onClick() {
      return setIsShowTimeZone(!isShowTimeZone);
    }
  }, filterList === null || filterList === void 0 ? void 0 : filterList.timeZone), isShowTimeZone && /*#__PURE__*/_react.default.createElement(_styles.TimeZoneSelectWrapper, {
    ref: timeZoneRef
  }, /*#__PURE__*/_react.default.createElement(_styles.TimeZoneSearchWrapper, null, /*#__PURE__*/_react.default.createElement(_styles.TimeZoneSearchInput, {
    type: "text",
    placeholder: t('TIMEZONE', 'Timezone'),
    value: searchVal,
    onChange: filterTimeZone
  }), /*#__PURE__*/_react.default.createElement(_styles.SearchIconWrapper, null, /*#__PURE__*/_react.default.createElement(_GoSearch.default, null))), /*#__PURE__*/_react.default.createElement(_styles.TimeZoneListContainer, null, timeZoneList && timeZoneList.map(function (timezone, i) {
