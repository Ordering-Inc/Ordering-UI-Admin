...
var AnalyticsRegisterUsers = function AnalyticsRegisterUsers(props) {
  ...
  var downloadImage = function downloadImage() {
    ...
    a.download = "".concat(t('REGISTER_USERS', 'Register Users'), ".png"); // Trigger the download
  ...
  }))), /*#__PURE__*/_react.default.createElement(_styles.RegisterUserChartWrapper, null, (registerUsersList === null || registerUsersList === void 0 ? void 0 : registerUsersList.loading) ? /*#__PURE__*/_react.default.createElement(_reactLoadingSkeleton.default, {
    height: 150
