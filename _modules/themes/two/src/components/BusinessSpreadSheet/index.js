...
var BusinessSpreadSheetUI = function BusinessSpreadSheetUI(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (spreadSheetState === null || spreadSheetState === void 0 ? void 0 : (_spreadSheetState$res = spreadSheetState.result) === null || _spreadSheetState$res === void 0 ? void 0 : _spreadSheetState$res.error) {
