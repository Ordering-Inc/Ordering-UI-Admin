...
var BusinessHeaderStyled = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  background: #CCC;\n  width: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  height: 150px;\n  border-radius: 8px;\n  margin-top: 20px;\n  ", "\n\n  @media (min-width: 768px) {\n    height: 180px;\n  }\n"])), function (_ref) {
...
var BusinessDetailsContent = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  margin-top: 60px;\n"])));

exports.BusinessDetailsContent = BusinessDetailsContent;

var BusinessDescription = _styledComponents.default.p(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  color: ", ";\n  margin: 25px 0;\n"])), function (props) {
  return props.theme.colors.headingColor;
});

exports.BusinessDescription = BusinessDescription;

var BusinessConfigsContainer = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  border: 1px solid #E9ECEF;\n  border-radius: 8px;\n  margin-bottom: 50px;\n  > div:last-child {\n    border-bottom: none;\n  }\n"])));

exports.BusinessConfigsContainer = BusinessConfigsContainer;

var BusinessConfigItem = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  padding: 10px 15px;\n  display: flex;\n  justify-content: space-between;\n  color: ", ";\n  border-bottom: 1px solid #E9ECEF;\n  span {\n    font-size: 14px;\n  }\n\n  ", "\n  \n  svg {\n    font-size: 20px;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
}, function (_ref2) {
