...
var Option = _styledComponents.default.div(_templateObject(), function (_ref) {
  ...
  return isDefault ? (0, _styledComponents.css)(_templateObject2()) : (0, _styledComponents.css)(_templateObject3());
}, function (props) {
  var _props$theme;
...
var PlaceholderTitle = (0, _styledComponents.default)(Option)(_templateObject5(), function (_ref2) {
  var isDefault = _ref2.isDefault;
  return isDefault ? (0, _styledComponents.css)(_templateObject6()) : (0, _styledComponents.css)(_templateObject7());
});
