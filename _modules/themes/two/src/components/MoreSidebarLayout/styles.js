...
var MainContainer = _styledComponents.default.div(_templateObject(), function (props) {
  ...
  return ((_props$theme2 = props.theme) === null || _props$theme2 === void 0 ? void 0 : _props$theme2.rtl) ? (0, _styledComponents.css)(_templateObject4(), function (_ref) {
    var isExtendExtraOpen = _ref.isExtendExtraOpen;
    return isExtendExtraOpen ? '520px' : '20px';
  }) : (0, _styledComponents.css)(_templateObject5(), function (_ref2) {
