...
exports.DriverSelectorContainer = exports.DriverInfo = exports.DriverInfoContainer = exports.CustomerInfo = exports.InfoContent = exports.Photo = exports.PhotoWrapper = exports.BusinessInfo = exports.ButtonLink = void 0;
...
var ButtonLink = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  cursor: pointer;\n  padding: 3px;\n  margin: 0 5px;\n\n  &:hover {\n    background-color: ", ";\n    border-radius: 5px;\n  }\n\n  svg {\n    color: ", ";\n    font-size: 24px;\n  }\n"])), function (props) {
...
var BusinessInfo = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  padding: 15px 0;\n  border-bottom: 1px solid ", ";\n"])), function (props) {
...
var PhotoWrapper = _styledComponents.default.div(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  max-width: 48px;\n  max-height: 48px;\n  height: 48px;\n  width: 48px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.1);\n  border-radius: 7.6px;\n\n  svg {\n    width: 40px;\n    height: 40px;\n    border-radius: 50%;\n  }\n\n  @media print {\n    display: none;\n  }\n"])));

exports.PhotoWrapper = PhotoWrapper;

var PhotoStyled = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  position: relative;\n  background-repeat: no-repeat, repeat;\n  background-size: cover;\n  object-fit: cover;\n  background-position: center;\n  border-radius: 10px;\n"])));
...
var InfoContent = _styledComponents.default.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  flex: 1;\n  > div {\n    display: flex;\n    align-items: center;\n\n    svg {\n      font-size: 20px;\n    }\n    > p {\n      margin: 0px;\n      font-weight: 600;\n      color: ", ";\n      display: -webkit-box;\n      -webkit-box-orient: vertical;\n      -webkit-line-clamp: 2;\n      overflow: hidden;\n    }\n  }\n\n  > p {\n    color: ", ";\n    font-size: 12px;\n    margin: 0px;\n  }\n\n  ", "\n"])), function (props) {
  ...
  return (_props$theme$colors5 = props.theme.colors) === null || _props$theme$colors5 === void 0 ? void 0 : _props$theme$colors5.lightGray;
}, function (props) {
  var _props$theme;
...
var CustomerInfo = (0, _styledComponents.default)(BusinessInfo)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral([""])));
exports.CustomerInfo = CustomerInfo;

var DriverInfoContainer = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));

exports.DriverInfoContainer = DriverInfoContainer;
var DriverInfo = (0, _styledComponents.default)(BusinessInfo)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  border-bottom: none;\n"])));
exports.DriverInfo = DriverInfo;

var DriverSelectorContainer = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  min-width: 40%;\n  > div {\n    width: 100%;\n    border-radius: 8px;\n    border-color: ", ";\n    > div {\n      background-color: ", ";\n      > div:first-child {\n        color: ", ";\n      }\n    }\n  }\n"])), function (props) {
