...
var LogoImage = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  ", "\n  height: 72px;\n  width: 72px;\n  overflow: hidden;\n  cursor: -webkit-grab;\n  cursor: grab;\n  background: #E9ECEF;\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n\n  ", "\n\n  img,\n  div {\n    width: 100%;\n    border-radius: 7.6px;\n    height: 100%;\n    overflow: hidden;\n    position: relative;\n  };\n\n  img{\n    object-fit: cover;\n  }\n"])), function (props) {
  ...
  var isEdit = _ref5.isEdit;
  return !isEdit && (0, _styledComponents.css)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n    pointer-event: none;\n  "])));
});

exports.LogoImage = LogoImage;

var SmallLogoImage = _styledComponents.default.div(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  transform: translate3d(45px,0px,0px);\n  ", "\n  height: 24px;\n  width: 24px;\n  overflow: hidden;\n  background: #E9ECEF;\n  border-radius: 7.6px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  svg {\n    width: 16px;\n    height: 16px;\n  }\n"])), function (props) {
  var _props$theme2;
...
var FormGroup = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  margin-top: 20px;\n"])));

exports.FormGroup = FormGroup;

var FormControl = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  margin-bottom: 30px;\n\n  input, textarea {\n    background: #FFFFFF;\n    border: 1px solid #DEE2E6;\n    box-sizing: border-box;\n    border-radius: 7.6px;\n    font-size: 14px;\n    padding: 10px 15px;\n    outline: none;\n    width: 100%;\n  }\n\n  textarea {\n    width: 100%;\n  }\n\n  .select {\n    width: 100%;\n    background: #F8F9FA;\n    color: #748194;\n    border: none;\n\n    > div:first-child {\n      font-size: 14px;\n      padding-top: 5px;\n      padding-bottom: 5px;\n\n      div:first-child {\n        font-size: 14px;\n        padding: 1px 0;\n      }\n    }\n  }\n"])));

exports.FormControl = FormControl;

var Label = _styledComponents.default.label(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-size: 14px;\n  color: ", ";\n  margin-bottom: 10px;\n"])), function (props) {
  var _props$theme3;
...
var Option = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  column-gap: 10px;\n  font-size: 13px;\n  line-height: 2;\n  font-weight: 500;\n"])));

exports.Option = Option;
var SocialImage = (0, _styledComponents.default)(BusinessImg)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  height: 150px;\n\n  @media (min-width: 768px) {\n    height: 140px;\n  }\n"])));
exports.SocialImage = SocialImage;

var CameraIconContainer = _styledComponents.default.span(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 17px;\n  right: 15px;\n"])));
