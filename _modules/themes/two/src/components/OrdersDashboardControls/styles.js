...
var OrderDashboardControlsContainer = _styledComponents.default.div(_templateObject(), function (props) {
  var _props$theme;
...
var InnerContnet = _styledComponents.default.div(_templateObject4());

exports.InnerContnet = InnerContnet;

var WrapOrderStatusTypeSelector = _styledComponents.default.div(_templateObject5(), function (props) {
