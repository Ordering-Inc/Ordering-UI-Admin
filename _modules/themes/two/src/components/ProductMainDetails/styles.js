...
var ProductDetailsContainer = _styledComponents.default.div(_templateObject());
...
var ProductName = _styledComponents.default.h1(_templateObject3(), function (props) {
...
var CloseButton = _styledComponents.default.span(_templateObject8(), function (props) {
  return props.theme.colors.headingColor;
});

exports.CloseButton = CloseButton;

var ProductImageStyled = _styledComponents.default.div(_templateObject9());
...
var ProductDetailsContent = _styledComponents.default.div(_templateObject10());

exports.ProductDetailsContent = ProductDetailsContent;

var ProductPrice = _styledComponents.default.p(_templateObject11(), function (props) {
  return props.theme.colors.headingColor;
});

exports.ProductPrice = ProductPrice;

var ProductDescription = _styledComponents.default.p(_templateObject12(), function (props) {
  return props.theme.colors.headingColor;
});

exports.ProductDescription = ProductDescription;

var ProductConfigsContainer = _styledComponents.default.div(_templateObject13());

exports.ProductConfigsContainer = ProductConfigsContainer;

var ProductConfigOption = _styledComponents.default.div(_templateObject14(), function (props) {
  return props.theme.colors.lightGray;
}, function (_ref) {
  var active = _ref.active;
  return active && (0, _styledComponents.css)(_templateObject15(), function (props) {
    return props.theme.colors.headingColor;
  });
});
