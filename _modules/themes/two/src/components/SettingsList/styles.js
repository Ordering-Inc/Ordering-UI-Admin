...
var FormGroupCheck = _styledComponents.default.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  padding-bottom: 20px;\n  border-bottom: 1px solid #E9ECEF;\n\n  input {\n    width: 16px;\n    height: 16px;\n    box-sizing: border-box;\n    border-radius: 2px;\n    margin-right: 10px;\n  }\n  label {\n    font-size: 14px;\n    display: flex;\n    align-items: center;\n    color: ", ";\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
});

exports.FormGroupCheck = FormGroupCheck;

var FormGroupWrapper = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  padding-top: 20px;\n"])));

exports.FormGroupWrapper = FormGroupWrapper;

var Required = _styledComponents.default.span(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  font-weight: 600;\n  font-size: 10px;\n  color: #E63757;\n"])));
