...
var UserInfo = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  border-top: 1px solid #E9ECEF;\n  transition: 0.1s;\n\n  @media (min-width: 760px) {\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var CollapseButton = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  top: 25px;\n  ", "\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n  cursor: pointer;\n  svg {\n    font-size: 18px;\n    transition: transform 0.4s ease;\n  }\n\n  ", "\n"])), function (props) {
  var _props$theme4;
  ...
  return isCollapse && (0, _styledComponents.css)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n    svg {\n      transform: rotate(180deg);\n    }\n  "])));
});

exports.CollapseButton = CollapseButton;

var IconContent = _styledComponents.default.span(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  position: absolute;\n  cursor: pointer;\n  top: 9px;\n  ", "\n\n  ", "\n  width: 35px;\n  height: 35px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 100%;\n  background-color: rgb(247, 247, 247);\n  box-shadow: transparent 0px 0px 0px 1px inset;\n\n  svg {\n    flex-shrink: 0;\n    font-size: 30px;\n  }\n"])), function (props) {
  var _props$theme5;
  ...
  return isClose && (0, _styledComponents.css)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n    ", "\n  "])), function (props) {
    var _props$theme6;
...
var MenuClose = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  position: relative;\n  height: 60px;\n"])));

exports.MenuClose = MenuClose;

var MenuContainer = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  margin: 5px 0;\n  > button {\n    width: 100%;\n    text-align: initial;\n  }\n"])));

exports.MenuContainer = MenuContainer;

var MenuContent = _styledComponents.default.div(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  padding: 5px 0;\n"])));

exports.MenuContent = MenuContent;

var SubMenu = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  padding: 5px 0;\n  font-size: 14px;\n  color: ", ";\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n\n  ", "\n  ", "\n"])), function (props) {
