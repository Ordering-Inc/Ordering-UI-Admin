...
var SidebarInnerContainer = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  height: 100%;\n  @media (min-width: 760px) {\n    height: 100vh;\n    position: sticky;\n    top: 0px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme;
...
var LogoWrap = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  height: 60px;\n  box-sizing: border-box;\n  background-color: #FFF;\n\n  @media (min-width: 760px) {\n    height: 80px;\n  }\n"])));

exports.LogoWrap = LogoWrap;

var SidebarContent = _styledComponents.default.div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  flex: 1;\n  box-sizing: border-box;\n  transition: 0.1s;\n  border-top: 1px solid ", ";\n  border-bottom: 1px solid ", ";\n  button {\n    display: flex;\n    font-size: 14px;\n    box-sizing: border-box;\n    svg {\n      font-size: 20px;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.borderColor;
}, function (props) {
  return props.theme.colors.borderColor;
});
...
var UserInfo = _styledComponents.default.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  transition: 0.1s;\n"])));

exports.UserInfo = UserInfo;

var CollapseButton = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  top: 25px;\n  ", "\n  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.12);\n  border-radius: 7.6px;\n  cursor: pointer;\n  svg {\n    font-size: 18px;\n    transition: transform 0.4s ease;\n  }\n\n  ", "\n"])), function (props) {
  var _props$theme2;
  ...
  return isCollapse && (0, _styledComponents.css)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    svg {\n      transform: rotate(180deg);\n    }\n  "])));
});

exports.CollapseButton = CollapseButton;

var IconContent = _styledComponents.default.span(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  position: absolute;\n  cursor: pointer;\n  top: 9px;\n  ", "\n\n  ", "\n  width: 35px;\n  height: 35px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 100%;\n  background-color: rgb(247, 247, 247);\n  box-shadow: transparent 0px 0px 0px 1px inset;\n\n  svg {\n    flex-shrink: 0;\n    font-size: 24px;\n  }\n"])), function (props) {
  var _props$theme3;
  ...
  return isClose && (0, _styledComponents.css)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n    ", "\n  "])), function (props) {
    var _props$theme4;
...
var MenuClose = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  position: relative;\n  height: 60px;\n"])));

exports.MenuClose = MenuClose;

var MenuContainer = _styledComponents.default.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  margin: 5px 0;\n  > button {\n    width: 100%;\n    text-align: initial;\n  }\n"])));

exports.MenuContainer = MenuContainer;

var MenuContent = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  padding: 5px 0;\n"])));

exports.MenuContent = MenuContent;

var SubMenu = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  padding: 5px 0;\n  font-size: 14px;\n  color: ", ";\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n\n  ", "\n  ", "\n"])), function (props) {
