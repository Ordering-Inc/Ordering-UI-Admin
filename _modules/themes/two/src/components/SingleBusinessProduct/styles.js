...
var BusinessGeneralInfo = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  ", "\n  p {\n    margin: 0;\n  }\n  input {\n    font-weight: 500;\n    font-size: 13px;\n    color: ", ";\n    border: 1px solid transparent;\n    outline: none;\n    transition: all 0.3s;\n    border-radius: 3px;\n    padding: 5px;\n  }\n  &:hover {\n    input {\n      border: 1px solid ", ";\n      background: white;\n    }\n  }\n"])), function (props) {
  var _props$theme;
...
var WrapperImage = _styledComponents.default.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  max-width: 38px;\n  max-height: 38px;\n  min-width: 38px;\n  height: 38px;\n  width: 38px;\n  filter: drop-shadow(0px 1px 4px rgba(0, 0, 0, 0.1));\n  border-radius: 10px;\n  ", "\n"])), function (props) {
  var _props$theme2;
...
var InfoBlock = _styledComponents.default.div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  input, textarea {\n    font-weight: 500;\n    font-size: 13px;\n    color: ", ";\n    border: 1px solid transparent;\n    outline: none;\n    transition: all 0.3s;\n    border-radius: 3px;\n    padding: 5px;\n    &.product_description {\n      font-size: 12px;\n      color: ", ";\n      resize: none;\n      width: 100%;\n    }\n  }\n  &:hover {\n    > input, textarea {\n      border: 1px solid ", ";\n      background: white;\n    }\n  }\n"])), function (props) {
  return props.theme.colors.headingColor;
}, function (props) {
  return props.theme.colors.lightGray;
}, function (props) {
...
var BusinessEnableWrapper = _styledComponents.default.div(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  span {\n    font-size: 14px;\n    ", "\n  }\n"])), function (props) {
  var _props$theme3;
...
var ProductTypeImage = _styledComponents.default.div(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  min-height: 38px;\n  min-width: 38px;\n  height: 38px;\n  width: 38px;\n  border-radius: 8px;\n  overflow: hidden;\n  cursor: -webkit-grab;\n  cursor: grab;\n  filter: drop-shadow(0px 1px 4px rgba(0, 0, 0, 0.1));\n  ", "\n  ", "\n  img,\n  div {\n    width: 100%;\n    border-radius: 8px;\n    height: 100%;\n    overflow: hidden;\n  };\n  img{\n    object-fit: cover;\n  }\n"])), function (props) {
  ...
  return disabled && (0, _styledComponents.css)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n    pointer-events: none;\n  "])));
});

exports.ProductTypeImage = ProductTypeImage;

var UploadWrapper = _styledComponents.default.div(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  border-radius: 5px;\n  background: ", ";\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  svg {\n    color: white;\n  }\n"])), function (props) {
  return props.theme.colors.lightGray;
});
