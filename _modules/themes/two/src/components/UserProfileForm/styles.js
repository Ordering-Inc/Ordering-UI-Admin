...
var UserData = _styledComponents.default.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  width: 100%;\n  color: ", ";\n\n  h1 {\n    font-size: 16px;\n    font-weight: 600;\n  }\n\n  > * {\n    margin: 5px 0;\n    width: 75%;\n    font-size: 14px;\n  }\n\n  @media (min-width: 768px){\n    align-items: flex-start;\n    text-align: left;\n    ", "\n  }\n"])), function (props) {
...
var WrapperForm = _styledComponents.default.div(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  margin-bottom: 30px;\n  @media (min-width: 768px) {\n    width: 100%;\n  }\n"])));
