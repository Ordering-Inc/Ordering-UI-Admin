...
var _currency = _interopRequireDefault(require("../config/currency.json"));
...
var getCurrenySymbol = function getCurrenySymbol(code) {
  ...
  return (_CURRENCY$code$symbol = _currency.default === null || _currency.default === void 0 ? void 0 : (_CURRENCY$code = _currency.default[code]) === null || _CURRENCY$code === void 0 ? void 0 : _CURRENCY$code.symbol) !== null && _CURRENCY$code$symbol !== void 0 ? _CURRENCY$code$symbol : code;
};
