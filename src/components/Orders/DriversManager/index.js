...
import {
  ...
  DriversContainer,
  DriversContent, WarningMessage, SearchWrapper
} from './styles'
import { TiWarningOutline } from '@meronex/icons/all'
          ...
          <SearchWrapper>
            ...
            {!!searchValue && (
              <WarningMessage>
                ...
                <LinkButton onClick={() => handleChangeSearch('')}>{t('CLEAR_FILTERS', 'Clear filters')}</LinkButton>
              </WarningMessage>
            )}
          </SearchWrapper>
        </DriversHeader>
