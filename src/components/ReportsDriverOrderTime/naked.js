...
export const ReportsDriverOrderTime = (props) => {
  ...
  const getOrderDistanceList = async () => {
    ...
    try {
      ...
      const functionFetch = `${ordering.root}/reports/driver_companies_order_time_ranges?${params}`
...
ReportsDriverOrderTime.propTypes = {
  /**
...
ReportsDriverOrderTime.defaultProps = {
  beforeComponents: [],
  afterComponents: [],
  beforeElements: [],
  afterElements: []
