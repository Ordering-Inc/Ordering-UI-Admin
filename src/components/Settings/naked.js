...
const categoryHideList = ['cloudinary', 'tookan', 'order_type', 'others', 'apple_login', 'location']
const configHideList = ['search_by_address', 'stripe_connect_sandbox', 'distance_unit_km', 'google_login_client_id']
