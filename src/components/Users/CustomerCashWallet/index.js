...
import { useLanguage, useUtils, UserCashWallet as UserCashWalletController } from 'ordering-components-admin'
...
export const CustomerCashWallet = (props) => {
  const cashWalletProps = {
    ...props,
    UIComponent: CustomerCashWalletUI
  }
  return <UserCashWalletController {...cashWalletProps} />
}
