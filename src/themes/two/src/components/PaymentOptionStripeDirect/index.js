...
export const PaymentOptionStripeDirect = (props) => {
  ...
  const [businessPaymethod, setBuisinessPaymethod] = useState(props.businessPaymethod)
  ...
  useEffect(() => {
    const updatedPaymethod = businessPaymethodsState.paymethods.find(paymethod => paymethod.paymethod_id === businessPaymethod.paymethod_id)
    setBuisinessPaymethod(updatedPaymethod)
